...
(self.webpackChunk_canva_web = self.webpackChunk_canva_web || []).push([
    [25436], {
        435135: (t, e) => {
            ...
            class S {
                constructor({
                    ...
                    this.primitive = _[t], this.shader = e, this.attributes = function(t) {
                        ...
                        return e
                    }(n), this.indices = r ? (d = r, Array.isArray(d) && (d = new Uint16Array(d)), p(d) && (d = new w(d)), d) : void 0, this.count = i, this.instances = o, this.uniforms = s, this.textures = a, this._cullFace = l ? A[l] : void 0, this._frontFace = f ? O[f] : 2305, this.blend = u ? function(t) {
                        var e, n;
                        const r = { ...R,
                                ...null != (e = t.rgb) ? e : t
                            },
            ...
            class I {
                constructor(t) {
                    this.id = f(), this.resourceType = "texture", this.textureType = "image", this.size = k, this.colorFormat = "rgba", this.numberFormat = "u8", this.source = t.source, this.name = t.name, this.alpha = t.alpha || L
                }
                get width() {
            ...
            class j {
                constructor(t) {
                    this.id = f(), this.resourceType = "texture", this.textureType = "binary", this.size = k, this.source = t.source, this.name = t.name, this.alpha = t.alpha || L, this.width = t.width, this.height = t.height
                }
                get colorFormat() {
            ...
            class B {
                constructor(t) {
                    this.id = f(), this.resourceType = "texture", this.textureType = "render", this.source = null, this.name = t.name, this.alpha = t.alpha || L, this.size = t.size || k, this.width = t.width || ("fixed" === this.size ? 0 : 1), this.height = t.height || ("fixed" === this.size ? 0 : 1), this.colorFormat = t.colorFormat, this.numberFormat = t.numberFormat
                }
            }
            ...
            function H(t, e, n) {
                ...
                if (t.shaderSource(o, n), t.compileShader(o), t.getShaderParameter(o, t.COMPILE_STATUS)) return o; {
            ...
            function G(t, e) {
                const n = function(t, e, n) {
                    ...
                    if (t.attachShader(o, s), t.attachShader(o, a), t.linkProgram(o), t.deleteShader(s), t.deleteShader(a), t.getProgramParameter(o, t.LINK_STATUS)) return o;
                    throw new r(`Could not link program. Details: ${t.getProgramInfoLog(o)}`)
                ...
                for (let r = 0; r < o; r++) {
                    ...
                    if (!e || -1 === i) throw new u(`Could not cache attribute. Could not find attribute or location at index ${r}. This is likely a bug with the renderer.`);
                    const o = b.get(e.type);
                    if (!o) throw new a(`Type of attribute '${e.name}' is not supported.`);
                    t.enableVertexAttribArray(i), s.set(e.name, {
                        location: i,
                        meta: o
                    })
                }
                ...
                for (let r = 0; r < c; r++) {
                    ...
                    if (!e || !i) throw new u(`Could not cache uniform. Could not find uniform or location at index ${r}. This is likely a bug with the renderer.`);
            ...
            function q(t, e, n) {
                ...
                if (!a) throw new i(`Could not create \`WebGLTexture\` for texture: ${function(t){return JSON.stringify(t,(function(t,e){if("resourceType"!==t){if(e instanceof Uint8Array||e instanceof Float32Array){const{length:t}=e;return{length:t}}if(e instanceof HTMLImageElement||e instanceof HTMLVideoElement){const{src:t,width:n,height:r}=e;return{src:t,width:n,height:r}}return e}console.log("stripping resource type",e)}),2)}(e)}`);
                t.bindTexture(o, a), t.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL, "premultiply" === e.alpha);
                const u = "rgb" === e.colorFormat ? t.RGB : t.RGBA,
                    ...
                    l = function(t, e) {
                        if ("image" === e.textureType) {
                            ...
                            if (t instanceof HTMLImageElement) return `${t.src}:${t.currentSrc}:${z(e)}`;
                            if (t instanceof HTMLVideoElement) return `${t.src}:${t.currentSrc}:${t.currentTime}:${z(e)}`
                ...
                if (f && h)
                    if ("image" !== e.textureType) {
                        ...
                        t.texImage2D(o, 0, r, i, s, 0, u, c, n)
                    } else {
                        const n = e.source;
                        (function(t) {
                        ...
                        }(n.src) && !n.crossOrigin && console.warn(`Fragl warning: ${n.src} image may come from a different origin but you did not set the crossOrigin attribute.`), t.texImage2D(o, 0, u, u, c, n)
                    }
                const p = "f32" === e.numberFormat ? t.NEAREST : t.LINEAR;
                return t.texParameteri(o, t.TEXTURE_MIN_FILTER, p), t.texParameteri(o, t.TEXTURE_MAG_FILTER, p), t.texParameteri(o, t.TEXTURE_WRAP_S, t.CLAMP_TO_EDGE), t.texParameteri(o, t.TEXTURE_WRAP_T, t.CLAMP_TO_EDGE), t.bindTexture(o, null), {
                    texture: a,
                    hash: l
                }
            }
            ...
            class X {
                constructor(t, e) {
                    this.gl = t, this.bufferCache = new Map, this.shaderCache = new Map, this.textureCache = new Map, this.handleContextLost = t => {
                        if (this.onContextLost) {
                            ...
                            t && (e = (null == t ? void 0 : t.statusMessage) || "No statusMessage"), this.onContextLost(new o(`Error: WebGL context lost - ${e}`))
                        }
                    ...
                    this.canvas.width = ((null == e ? void 0 : e.width) || r) * this.env.devicePixelRatio, this.canvas.height = ((null == e ? void 0 : e.height) || i) * this.env.devicePixelRatio, this.canvas.addEventListener("webglcontextlost", this.handleContextLost, {
                        once: !0
                    }), this.fbo = t.createFramebuffer(), this.vertexAttribArrayState = new W(t)
                }
                flush() {
                    this.gl.flush()
                }
                ...
                load(t) {
                    ...
                    for (const r of n) switch (r.resourceType) {
                        ...
                        case "shader":
                            ...
                            break;
                        case "texture":
                            this.textureCache.has(r.id) || this.textureCache.set(r.id, q(e, r));
                            break;
                        default:
                            throw new c(r)
                    }
                ...
                update(t) {
                    ...
                    for (const r of n)
                        if ("texture" === r.resourceType) {
                            ...
                            if (!t) throw new o(`Could not update texture with ID: '${r.id}'. Did you remember to use load()?`);
                            this.textureCache.set(r.id, q(e, r, t))
                        }
                }
                clear(t, e) {
                    var n;
                    ...
                    if (e) {
                        ...
                        if (!t) throw new o(`Could not find render target with ID: ${e.id}. Did you remember to use load()?`);
                ...
                render(t) {
                    ...
                    for (const p of h) {
                        ...
                        if (!t) throw new o(`Could not find shader with ID: ${p.shader.id}. Did you remember to use load()?`);
                        if (p.blend) {
                            const {
                                rgb: t,
                                alpha: e
                        ...
                        for (const [s, {
                            ...
                            if (!t) throw new o(`Could not locate shader attribute ${s} within Renderable's attributes.`);
                            const c = d(null != (e = t.type) ? e : t.buffer.dataType),
                                l = this.getBuffer(t.buffer);
                            f.bindBuffer(f.ARRAY_BUFFER, l), f.vertexAttribPointer(a, u.length, c, null != (n = t.normalized) && n, null != (r = t.stride) ? r : 0, null != (i = t.offset) ? i : 0), p.instances && t.divisor && h.vertexAttribDivisorANGLE(a, t.divisor)
                        }
                        ...
                        for (const [e, n] of t.textures.entries()) {
                            ...
                            if (!r) throw new o(`Could not find texture with ID: ${t.id}. Did you remember to use load()?`);
                            f.bindTexture(f.TEXTURE_2D, r)
                        }
                        if (p.renderTarget) {
                            const t = null == (c = this.textureCache.get(p.renderTarget.id)) ? void 0 : c.texture;
                            if (!t) throw new o(`Could not find render target with ID: ${p.renderTarget.id}. Did you remember to use load()?`);
                            const {
                                width: e,
                                height: n
                            } = V(f, p.renderTarget);
                ...
                readPixels(t) {
                    ...
                    let r;
                    if (t) {
                        const i = null == (e = this.textureCache.get(t.id)) ? void 0 : e.texture;
                        if (!i) throw new o(`Could not find render target with ID: ${t.id}. Did you remember to use load()?`);
                        r = V(n, t), n.bindFramebuffer(n.FRAMEBUFFER, this.fbo), n.framebufferTexture2D(n.FRAMEBUFFER, n.COLOR_ATTACHMENT0, n.TEXTURE_2D, i, 0)
                    ...
                    return n.readPixels(0, 0, r.width, r.height, n.RGBA, n.UNSIGNED_BYTE, i), new ImageData(new Uint8ClampedArray(i.buffer), r.width, r.height)
                }
                dispose() {
                    var t;
                    const e = this.gl;
                ...
                deleteResource(t, e) {
                    ...
                    switch (e) {
                        ...
                        case "shader":
                            ...
                            r.deleteProgram((null == o ? void 0 : o.program) || null), this.shaderCache.delete(t);
                            break;
                        case "texture":
                ...
                getBuffer(t) {
                    ...
                    if (!e) throw new o(`Could not find buffer with ID: ${t.id}. Did you remember to use load()?`);
                    return e
                }
                get commonUniforms() {
                    return {
            ...
            function et(t, e, n, r, i = Q) {
                const o = i;
                let s = o.find((i => !t.includes(i.texture) && e === i.width && n === i.height && r === i.size));
            ...
            const rt = class t {
                ...
                constructor({
                    ...
                    const f = this.createRenderTextures(u, a, o);
                    this.renderables = this.getRenderables(u, f, a, r, o)
                }
                convertShorthands(t, e) {
                    return {
                        ...
                        uniforms: Object.fromEntries(Object.entries(null != e ? e : {}).map((([t, e]) => [t, J(e)])))
                    }
                }
                createRenderTextures(t, e, n) {
                    const r = new Map;
                    for (const i of t) i.output && r.set(i.output, et([...e.textures, ...r.values()], null == n ? void 0 : n.width, null == n ? void 0 : n.height, null == n ? void 0 : n.size));
                    return r
                }
                getRenderables(t, e, n, r, i) {
                    const o = t.slice(0, -1).map((t => {
                        ...
                        s = i ? this.finalPassShaderForRenderTexture : this.finalPassShaderForCanvas;
                    return [...o, this.getRenderable(t[t.length - 1], s, n.currentBuffer(), i, e, r)]
                }
                getRenderable(t, e, n, r, i, o) {
                    const s = this.uniforms,
                        a = this.getTextures(t, { ...o,
                            [K]: n
                        }, i),
                        u = this.enableOneTriangleOptimisation ? Z : Y;
                    return new S({ ...u,
                        shader: e,
                        uniforms: s,
                        textures: a,
                ...
                update({
                    ...
                    if (t)
                        for (const [r, i] of Object.entries(t))
                            if (i)
                                for (const t of this.renderables) t.textures[r] = i;
                    if (e)
                        for (const [r, i] of Object.entries(e)) this.uniforms[r] && (this.uniforms[r] = J(i));
                    if (void 0 !== n) {
            ...
            rt.enableOneTriangleOptimisation = !1;
            let it, ot, st = rt;

            function at(t, e) {
                if (!(it && ot || (it = document.createElement("canvas"), ot = it.getContext("2d"), ot))) throw new n("Unable to establish `CanvasRenderingContext2D` for debugging");
                return it.width = t, it.height = e, {
                    canvas: it,
                    context: ot
                }
            }
            ...
            function ct(t) {
                ...
                t.source instanceof ImageData ? i.putImageData(t.source, 0, 0) : i.drawImage(t.source, 0, 0);
                ft(t, r.toDataURL(), e / n)
            }
            ...
            const ht = "LkEaxkGQc",
                ...
                Ot = "MpMrqOkTf";
            var xt = 1e-6,
                Rt = "undefined" != typeof Float32Array ? Float32Array : Array;

            function Nt() {
                var t = new Rt(9);
                return Rt != Float32Array && (t[1] = 0, t[2] = 0, t[3] = 0, t[5] = 0, t[6] = 0, t[7] = 0), t[0] = 1, t[4] = 1, t[8] = 1, t
            }

            function St() {
                var t = new Rt(16);
                return Rt != Float32Array && (t[1] = 0, t[2] = 0, t[3] = 0, t[4] = 0, t[6] = 0, t[7] = 0, t[8] = 0, t[9] = 0, t[11] = 0, t[12] = 0, t[13] = 0, t[14] = 0), t[0] = 1, t[5] = 1, t[10] = 1, t[15] = 1, t
            }
            ...
            function Pt(t, e, n) {
                var r = e[0],
                    ...
                    w = n[2],
                    _ = n[3];
                return t[0] = g * r + E * a + w * f + _ * y, t[1] = g * i + E * u + w * h + _ * v, t[2] = g * o + E * c + w * p + _ * m, t[3] = g * s + E * l + w * d + _ * b, g = n[4], E = n[5], w = n[6], _ = n[7], t[4] = g * r + E * a + w * f + _ * y, t[5] = g * i + E * u + w * h + _ * v, t[6] = g * o + E * c + w * p + _ * m, t[7] = g * s + E * l + w * d + _ * b, g = n[8], E = n[9], w = n[10], _ = n[11], t[8] = g * r + E * a + w * f + _ * y, t[9] = g * i + E * u + w * h + _ * v, t[10] = g * o + E * c + w * p + _ * m, t[11] = g * s + E * l + w * d + _ * b, g = n[12], E = n[13], w = n[14], _ = n[15], t[12] = g * r + E * a + w * f + _ * y, t[13] = g * i + E * u + w * h + _ * v, t[14] = g * o + E * c + w * p + _ * m, t[15] = g * s + E * l + w * d + _ * b, t
            }
            ...
            function Lt(t, e) {
                var n = e[0],
                    ...
                    v = o * a,
                    m = o * u;
                return t[0] = 1 - f - d, t[1] = l + m, t[2] = h - v, t[3] = 0, t[4] = l - m, t[5] = 1 - c - d, t[6] = p + y, t[7] = 0, t[8] = h + v, t[9] = p - y, t[10] = 1 - c - f, t[11] = 0, t[12] = 0, t[13] = 0, t[14] = 0, t[15] = 1, t
            }
            ...
            function It() {
                var t = new Rt(3);
                return Rt != Float32Array && (t[0] = 0, t[1] = 0, t[2] = 0), t
            }
            ...
            function Bt() {
                var t = new Rt(4);
                return Rt != Float32Array && (t[0] = 0, t[1] = 0, t[2] = 0), t[3] = 1, t
            }
            It(),
                function() {
                    var t = function() {
                        var t = new Rt(4);
                        return Rt != Float32Array && (t[0] = 0, t[1] = 0, t[2] = 0, t[3] = 0), t
                    }()
                }();
            ...
            const Vt = {
                ...
                zt = async t => (await fetch(t)).arrayBuffer(),
                Wt = t => (new TextDecoder).decode(t);
            class Xt {
                constructor(t, e, n) {
                ...
                async getBufferViewFromAccessor(t) {
                    ...
                    const e = qt[t.type],
                        n = Vt[t.componentType].BYTES_PER_ELEMENT * e * t.count;
                ...
                async bufferViewData(t, e) {
                    ...
                    const n = this.gltf.bufferViews[t],
                        ...
                        a = r.byteOffset;
                    switch (e) {
                        case Gt.GLTF_BUFFER_TYPE_BYTE:
                            return new Int8Array(s, a + o, i);
                        case Gt.GLTF_BUFFER_TYPE_UNSIGNED_BYTE:
                            return new Uint8Array(s, a + o, i);
                        case Gt.GLTF_BUFFER_TYPE_SHORT:
                            return new Int16Array(s, a + o, i / 2);
                        case Gt.GLTF_BUFFER_TYPE_UNSIGNED_SHORT:
                            return new Uint16Array(s, a + o, i / 2);
                        case Gt.GLTF_BUFFER_TYPE_UNSIGNED_INT:
                            return new Uint32Array(s, a + o, i / 4);
                        case Gt.GLTF_BUFFER_TYPE_FLOAT:
                ...
                async getBufferData(t) {
                    ...
                    })(e.uri) : await zt(this.baseUrl + e.uri);
                ...
                async getImageData(t) {
                    ...
                    if (void 0 !== e.bufferView) {
                        const t = await this.bufferViewData(e.bufferView, Gt.GLTF_BUFFER_TYPE_BYTE),
                            r = new Blob([t], {
                                type: e.mimeType
                            });
            ...
            const Kt = async t => {
                    let e;
                    e = t.startsWith("http") || t.startsWith("blob") ? t : (t => {
                        try {
                            JSON.parse(t)
                        } catch {
                    ...
                    const n = Zt(e),
                        r = await Yt(e);
                    return new Xt(n, r.json, r.chunks)
                },
                Zt = t => {
                    let e = "";
                    try {
                ...
                Yt = async t => {
                    ...
                    try {
                        ...
                        n = t.toString().startsWith("blob") || t.toString().startsWith("http") ? await zt(t) : t;
                        const e = new DataView(n, 0, 12);
                        r = {
                            magic: Wt(new Uint8Array(n, 0, 4)),
                            version: e.getUint32(4, !0),
                            length: e.getUint32(8, !0)
                        }
                    }
                    if ("glTF" !== r.magic || r.version < 2) throw new Error(`File format is not supported! Current header magic: ${r.magic}, version ${r.version}`);
                    if (r.length > 0) {
                        const t = $t(n);
                        e = t.json, i = t.chunks
                    }
                    if (void 0 === e) throw new Error("JSON content not found.");
                    if (void 0 === e.asset || parseFloat(e.asset.version) < 2) throw new Error("Unsupported asset. glTF versions >= 2.0 are supported.");
                    return {
                        json: e,
                        chunks: i
                    }
                ...
                Jt = "placeholder",
                Qt = t => t instanceof Uint16Array ? 5123 : t instanceof Uint32Array ? 5125 : 5121,
                te = t => {
                    const e = [];
                    return t.forEach(((t, n) => {
                        var r, i;
                        t.name.toLowerCase().includes(Jt) ? e.push({
                            meshIndex: n,
                            name: t.name
                        }) : null != (r = t.material) && r.name.toLowerCase().includes(Jt) && e.push({
                            meshIndex: n,
                ...
                ne = (t, e) => {
                    const n = (t => {
                            ...
                            return t.mesh.forEach(((n, r) => {
                                const i = n.uvs && n.uvs.length ? n.uvs : new Float32Array(n.positions.length / 3 * 2);
                                e.push({
                                    ...
                                    material: n.material,
                                    id: r,
                                    renderingContextBase: Qt(n.indices)
                                })
                            })), e
                        })(t),
                        r = (t => {
                    ...
                    return {
                        ...
                        placeholder: te(n),
                        targets: ee(t.mesh),
                        transform: t.translation.length > 0 ? Ct(St(), jt(t.translation[0], t.translation[1], t.translation[2])) : St(),
                        rotation: t.rotation.length > 0 ? Lt(St(), Mt(t.rotation[0], t.rotation[1], t.rotation[2], t.rotation[3])) : St(),
                        scale: t.scale.length > 0 ? jt(t.scale[0], t.scale[1], t.scale[2]) : jt(1, 1, 1),
                        name: t.name,
                        parrent: e,
            ...
            e.AdditiveBlending = {
                ...
                destination: "one",
                equation: "add"
            }, e.BinaryTexture = j, e.Buffer = E, e.Effect = st, e.ElementsBuffer = w, e.FraglAllocationError = i, e.FraglCompilationError = r, e.FraglError = n, e.FraglInternalError = u, e.FraglPlatformError = s, e.FraglRuntimeError = o, e.FraglValidationError = a, e.GltfParser = class {
                constructor(t) {
                    this.src = t, this.camera = re(), this.cameraModel = Ft(this.camera), this.nodes = [], this.clips = [], this.model = [], this.images = [], this.textures = [], this.samplers = []
                }
                async parse(t = {}) {
                    return this.model = [], this.asset = await Kt(this.src), this.images = await this.getTextureImages(t.imageFilesToReplace), this.updateTexturesData(), this.camera = re(), this.nodes = await this.getSubNodes(), this.cameraModel = this.getCameraModel(), this.clips = await this.getClips(), this.model = await this.getModel(), this.updateAnimation(), {
                                            ...
                                            for (let r = 0; r < n; r++) {
                                                ...
                                                for (let r = 0; r < e; r += 3) {
                                                    ...
                                                    for (let e = 0; e < t.targets.length; e++) {
                                                        const o = n + e;
                                                        i[r] += t.targets[e].positions[r] * t.values[o], i[r + 1] += t.targets[e].positions[r + 1] * t.values[o], i[r + 2] += t.targets[e].positions[r + 2] * t.values[o]
                                                    }
                                                }
                ...
                async getSubNodes(t, e) {
                    const n = this.getGltfFromAsset(),
                        ...
                        o = (void 0 === t ? i.nodes : t).map((async t => {
                            const r = n.nodes[t],
                                i = re(t, r.name);
                            return void 0 !== r.children && (i.children = await this.getSubNodes(r.children, r)), void 0 !== r.mesh && (i.mesh = await this.getSubMesh(n.meshes[r.mesh])), i.rotation = [0, 0, 0, 0], void 0 !== r.rotation ? i.rotation = r.rotation : void 0 !== e && void 0 !== e.rotation && (i.rotation[0] = i.rotation[0] * e.rotation[0], i.rotation[1] = i.rotation[1] * e.rotation[1], i.rotation[2] = i.rotation[2] * e.rotation[2], i.rotation[3] = i.rotation[3] * e.rotation[3]), i.translation = [0, 0, 0], void 0 !== r.translation ? i.translation = r.translation : void 0 !== e && void 0 !== e.translation && (i.translation[0] = i.translation[0] * e.translation[0], i.translation[1] = i.translation[1] * e.translation[1], i.translation[2] = i.translation[2] * e.translation[2]), i.scale = [1, 1, 1], void 0 !== r.scale ? i.scale = r.scale : void 0 !== e && void 0 !== e.scale && (i.scale[0] = i.scale[0] * e.scale[0], i.scale[1] = i.scale[1] * e.scale[1], i.scale[2] = i.scale[2] * e.scale[2]), void 0 !== r.camera && (i.camera = n.cameras[r.camera], this.camera = i), i.extras = void 0, void 0 !== r.extras && (i.extras = {
                                highlightCorrection: 1,
                                shadowCorrection: 1
                            }, i.extras.highlightCorrection = void 0 !== r.extras.Highlight_Correction ? r.extras.Highlight_Correction : 1, i.extras.shadowCorrection = void 0 !== r.extras.Shadow_Correction ? r.extras.Shadow_Correction : 1), i
                        }));
                ...
                constructor(t) {
                    this._renderables = {}, this.projectionMatrix = St(), this.viewMatrix = St(), this.modelMatrix = St(), this.modelViewProjectionMatrix = St(), this._renderables = t
                }
                get renderables() {
                ...
                updateAll({
                    ...
                    if (t)
                        for (const e of this.renderables) t.uCameraPosition && (e.uniforms[Tt] = t.uCameraPosition), t.uMVPMatrix && (e.uniforms[vt] = t.uMVPMatrix), t.uNormalMatrix && (e.uniforms[_t] = t.uNormalMatrix)
                }
                updateOne({
                    id: t,
                    textures: e
                    ...
                    e && e.uPlaceholderTexture && (n.textures[Et] = e.uPlaceholderTexture)
                }
                getUniformsToUpdateView(t, e) {
                    return {
                        uniforms: {
                            uCameraPosition: [...t],
                            uMVPMatrix: this.createMVPMatrix(e, t),
                            uNormalMatrix: this.createNormalMatrix()
                        }
                    }
                }
                createMVPMatrix(t, e) {
                    kt(this.projectionMatrix, .4, t, .01, 1e3);
                    const n = jt(0, 0, 0),
                        r = jt(0, 1, 0);
                    return function(t, e, n, r) {
                        var i, o, s, a, u, c, l, f, h, p, d = e[0],
                            y = e[1],
                            v = e[2],
                            m = r[0],
                            b = r[1],
                            ...
                            w = n[1],
                            _ = n[2];
                        Math.abs(d - E) < xt && Math.abs(y - w) < xt && Math.abs(v - _) < xt ? function(t) {
                            t[0] = 1, t[1] = 0, t[2] = 0, t[3] = 0, t[4] = 0, t[5] = 1, t[6] = 0, t[7] = 0, t[8] = 0, t[9] = 0, t[10] = 1, t[11] = 0, t[12] = 0, t[13] = 0, t[14] = 0, t[15] = 1
                        }(t) : (l = d - E, f = y - w, h = v - _, i = b * (h *= p = 1 / Math.hypot(l, f, h)) - g * (f *= p), o = g * (l *= p) - m * h, s = m * f - b * l, (p = Math.hypot(i, o, s)) ? (i *= p = 1 / p, o *= p, s *= p) : (i = 0, o = 0, s = 0), a = f * s - h * o, u = h * i - l * s, c = l * o - f * i, (p = Math.hypot(a, u, c)) ? (a *= p = 1 / p, u *= p, c *= p) : (a = 0, u = 0, c = 0), t[0] = i, t[1] = a, t[2] = l, t[3] = 0, t[4] = o, t[5] = u, t[6] = f, t[7] = 0, t[8] = s, t[9] = c, t[10] = h, t[11] = 0, t[12] = -(i * d + o * y + s * v), t[13] = -(a * d + u * y + c * v), t[14] = -(l * d + f * y + h * v), t[15] = 1)
                    }(this.viewMatrix, e, n, r), Pt(this.modelViewProjectionMatrix, this.viewMatrix, this.modelMatrix), Pt(this.modelViewProjectionMatrix, this.projectionMatrix, this.modelViewProjectionMatrix), Array.from(this.modelViewProjectionMatrix)
                }
                createNormalMatrix() {
                    const t = Nt();
                    return function(t, e) {
                ...
                gltfMeshToRenderable(t) {
                    ...
                    const {
                        ...
                        isDoubleSided: p
                    } = this.gltfMaterialToTextures(t.material, this.gltf.images, this.gltf.textures), d = r ? 1 : 0, y = l ? 1 : 0, v = h ? 1 : 0, m = u ? 1 : 0;
                    return new S({
                        attributes: {
                            [dt]: new E(t.vertices),
                            [yt]: new E(t.normals),
                ...
                constructor(t, {
                    ...
                    if (this.container = t, this.velocity = [0, 0], this.cameraPosition = [0, 0, 0], this.mousePosition = [0, 0], this.isMouseDown = !1, this.onMouseDown = t => {
                            t.preventDefault(), this.mousePosition[0] = t.x, this.mousePosition[1] = t.y, this.isMouseDown = !0
                        }, this.onMouseMove = t => {
                            if (!this.isMouseDown) return;
                            const {
                                x: e,
                                y: n
                            } = t, r = e - this.mousePosition[0], i = n - this.mousePosition[1], o = .3 * Math.sqrt(this.distance);
                            this.velocity[0] = r * o, this.velocity[1] = i * o, this.mousePosition[0] = e, this.mousePosition[1] = n, this.tick()
                        }, this.onMouseUp = t => {
                            ...
                            return Math.sqrt(t + e) < 5e-5 && (this.velocity[0] = 0, this.velocity[1] = 0), this.updatePosition(), this.cameraPosition
                        }, this.moveToRotation = (t, e) => (null != t && (this.rotation[0] = (t + 2 * Math.PI) % (2 * Math.PI)), null != e && (this.rotation[1] = Math.min(.99 * Math.PI, Math.max(.01, e))), this.velocity[0] = 0, this.velocity[1] = 0, this.updatePosition(), this.cameraPosition), this.zoomToDistance = t => {
                            if (null != t) return this.distance = Math.min(this.maxDistance, Math.max(t, this.minDistance)), this.velocity[0] = 0, this.velocity[1] = 0, this.updatePosition(), this.cameraPosition
                        }, this.checkCamera = () => this.cameraPosition, void 0 !== n && n <= 0) throw new a("Invalid value of minDistance. Expected value must be greater than 0.");
                    this.distance = null != e ? e : 1.5, this.minDistance = null != n ? n : .1, this.maxDistance = null != r ? r : 20, this.rotation = null != i ? i : [.5 * Math.PI, .5 * Math.PI], this.container.addEventListener("mousedown", this.onMouseDown, !1), window.addEventListener("mousemove", this.onMouseMove, !1), window.addEventListener("mouseup", this.onMouseUp, !1), this.updatePosition()
                }
                dispose() {
                    this.container.removeEventListener("mousedown", this.onMouseDown, !1), window.removeEventListener("mousemove", this.onMouseMove, !1), window.removeEventListener("mouseup", this.onMouseUp, !1)
                }
                updatePosition() {
                    const t = this.rotation[0],
                        e = this.rotation[1],
                        n = Math.cos(t) * Math.sin(e),
                        r = Math.cos(e),
                        i = Math.sin(t) * Math.sin(e);
                    this.cameraPosition[0] = n * this.distance, this.cameraPosition[1] = r * this.distance, this.cameraPosition[2] = i * this.distance
                }
            }, e.PingpongBuffers = nt, e.PremultipliedNormalBlending = {
                source: "one",
            ...
            }, e.Shader = C, e.WebGlRenderer = X, e._renderTexturePool = tt, e.createWebGlRenderer = function(t, e) {
                var n, r, o;
                ...
                if (s.removeEventListener("webglcontextcreationerror", u), !l) throw new i(`A WebGL context could not be created. Reason: ${a}`);
                return new X(l, { ...e,
                    onDispose: () => {
                        s.remove()
                    }
                })
            }, e.debugBinaryTexture = lt, e.debugImageTexture = ct, e.debugRenderTexture = ut, e.debugTexture = function(t, e) {
                e && "render" !== e.textureType ? "image" === e.textureType ? ct(e) : lt(e) : ut(t, e)
            }, e.getAbsoluteTextureSize = M, e.getPooledRenderTexture = et, e.injectAlphaPremultiplication = $, e.paddedTuple = function(t, e, n) {
        ...
        968: t => {
            ...
            window, e = function() {
                return function(t) {
                    ...
                    var A = function() {
                        function t(e) {
                            ...
                            if (function(t, e) {
                                ...
                                }(this, t), this.options = O(e, r), this.container = this.options.container, null == this.container) return _.error("Invalid Quill container", e);
                            ...
                            var o = this.options.registry.query(c.ScrollBlot.blotName);
                            this.scroll = new o(this.options.registry, this.root, {
                                ...
                                x.call(n, (function() {
                                    ...
                                    var e = g(t, 2),
                                        r = e[0],
                                        i = e[1];
                                    return n.selection.format(r, i)
                                }))
                            }));
                            var s = this.clipboard.convert({
                                html: "".concat(i, "<p><br></p>"),
                                text: "\n"
                            });
                        ...
                        return e = t, n = [{
                            ...
                            value: function(t, e, n) {
                                var r = this,
                                    i = g(R(t, e, n), 4);
                                return t = i[0], e = i[1], n = i[3], x.call(this, (function() {
                            ...
                            value: function(t, e) {
                                ...
                                return x.call(this, (function() {
                                    var r = n.getSelection(!0),
                                        o = new i.a;
                                    if (null == r) return o;
                                    if (n.scroll.query(t, c.Scope.BLOCK)) o = n.editor.formatLine(r.index, r.length, b({}, t, e));
                                    else {
                                        if (0 === r.length) return n.selection.format(t, e), o;
                                        o = n.editor.formatText(r.index, r.length, b({}, t, e))
                                    }
                                    return n.setSelection(r, f.a.sources.SILENT), o
                                }), r)
                            }
                        }, {
                            key: "formatLine",
                            value: function(t, e, n, r, i) {
                                var o, s = this,
                                    a = g(R(t, e, n, r, i), 4);
                                return t = a[0], e = a[1], o = a[2], i = a[3], x.call(this, (function() {
                                    return s.editor.formatLine(t, e, o)
                                }), i, t, 0)
                            }
                        }, {
                            key: "formatText",
                            value: function(t, e, n, r, i) {
                                var o, s = this,
                                    a = g(R(t, e, n, r, i), 4);
                                return t = a[0], e = a[1], o = a[2], i = a[3], x.call(this, (function() {
                                    return s.editor.formatText(t, e, o)
                                }), i, t, 0)
                            }
                        }, {
                            key: "getBounds",
                            ...
                            value: function(e, n, r) {
                                ...
                                return x.call(this, (function() {
                                    return i.editor.insertEmbed(e, n, r)
                                }), o, e)
                            }
                        }, {
                            key: "insertText",
                            value: function(t, e, n, r, i) {
                                var o, s = this,
                                    a = g(R(t, 0, n, r, i), 4);
                                return t = a[0], o = a[2], i = a[3], x.call(this, (function() {
                                    return s.editor.insertText(t, e, o)
                                }), i, t, e.length)
                            }
                        }, {
                            key: "isEnabled",
                            ...
                            value: function(e, n, r) {
                                if (null == e) this.selection.setRange(null, n || t.sources.API);
                                    ...
                                    var i = g(R(e, n, r), 4);
                                    e = i[0], n = i[1], r = i[3], this.selection.setRange(new p.a(Math.max(0, e), n), r), r !== f.a.sources.SILENT && this.selection.scrollIntoView(this.scrollingContainer)
                                }
                            }
                        }, {
                            key: "setText",
                            ...
                            value: function(t) {
                                var e = this,
                                    n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : f.a.sources.API;
                                return x.call(this, (function() {
                                    return t = new i.a(t), e.editor.applyDelta(t, n)
                                }), n, !0)
                            }
                        }], r = [{
                            key: "debug",
                            ...
                            value: function(t, e) {
                                ...
                                if ("string" != typeof t) {
                                    var i = t.attrName || t.blotName;
                                    "string" == typeof i ? this.register("formats/".concat(i), t, e) : Object.keys(t).forEach((function(r) {
                                        n.register(r, t[r], e)
                                    }))
                    ...
                    function x(t, e, n, r) {
                        if (!this.isEnabled() && e === f.a.sources.USER && !this.allowReadOnlyEdits) return new i.a;
                        var o = null == n ? null : this.getSelection(),
                            s = this.editor.delta,
                            a = t();
                        if (null != o && (!0 === n && (n = o.index), null == r ? o = N(o, a, e) : 0 !== r && (o = N(o, n, r, e)), this.setSelection(o, f.a.sources.SILENT)), a.length() > 0) {
                    ...
                    function R(t, e, n, r, i) {
                        var o = {};
                        return "number" == typeof t.index && "number" == typeof t.length ? "number" != typeof e ? (i = r, r = n, n = e, e = t.length, t = t.index) : (e = t.length, t = t.index) : "number" != typeof e && (i = r, r = n, n = e, e = 0), "object" === m(n) ? (o = n, i = r) : "string" == typeof n && (null != r ? o[n] = r : i = n), [t, e, o, i = i || f.a.sources.API]
                    }
                        ...
                        l = function() {
                            ...
                            return t.prototype.insert = function(t, e) {
                                ...
                                var e = this.ops.length,
                                    n = this.ops[e - 1];
                                if (t = o.default(t), "object" == typeof n) {
                                ...
                                for (var r = [], i = u.default.iterator(this.ops), o = 0; o < n && i.hasNext();) {
                                    var s = void 0;
                                    o < e ? s = i.next(e - o) : (s = i.next(n - o), r.push(s)), o += u.default.length(s)
                                }
                                return new t(r)
                                ...
                                if (null != o && "number" == typeof o.retain && null == o.attributes) {
                                    for (var c = o.retain;
                                        "insert" === n.peekType() && n.peekLength() <= c;) c -= n.peekLength(), i.push(n.next());
                                    o.retain - c > 0 && r.next(o.retain - c)
                                }
                                for (var l = new t(i); n.hasNext() || r.hasNext();)
                                    ...
                                    for (var e = t[1].length; e > 0;) {
                                        ...
                                        switch (t[0]) {
                                            ...
                                            case i.default.DELETE:
                                                n = Math.min(e, f.peekLength()), f.next(n), o.delete(n);
                                                break;
                                            case i.default.EQUAL:
                                                n = Math.min(f.peekLength(), h.peekLength(), e);
                                                var r = f.next(n),
                                                    u = h.next(n);
                                                s.default(r.insert, u.insert) ? o.retain(n, a.default.diff(r.attributes, u.attributes)) : o.push(u).delete(n)
                                        }
                                        e -= n
                                    }
                                })), o.chop()
                                ...
                                void 0 === n && (n = "\n");
                                for (var r = u.default.iterator(this.ops), i = new t, o = 0; r.hasNext();) {
                                    if ("insert" !== r.peekType()) return;
                                    var s = r.peek(),
                                        a = u.default.length(s) - r.peekLength(),
                                        c = "string" == typeof s.insert ? s.insert.indexOf(n, a) - a : -1;
                                    if (c < 0) i.push(r.next());
                                    else if (c > 0) i.push(r.next(c));
                                    else {
                                        if (!1 === e(i, r.next(1).attributes || {}, o)) return;
                                        o += 1, i = new t
                                    }
                                }
                                i.length() > 0 && e(i, {}, o)
                                ...
                                return this.reduce((function(t, r) {
                                    if (r.insert) n.delete(u.default.length(r));
                                        ...
                                        if (r.delete || r.retain && r.attributes) {
                                            var i = r.delete || r.retain;
                                            return e.slice(t, t + i).forEach((function(t) {
                                ...
                                for (var r = e, i = u.default.iterator(this.ops), o = u.default.iterator(r.ops), s = new t; i.hasNext() || o.hasNext();)
                                    if ("insert" !== i.peekType() || !n && "insert" === o.peekType())
                                        if ("insert" === o.peekType()) s.push(o.next());
                                        else {
                                            var c = Math.min(i.peekLength(), o.peekLength()),
                                                l = i.next(c),
                                                f = o.next(c);
                                            if (l.delete) continue;
                                            f.delete ? s.push(f) : s.retain(c, a.default.transform(l.attributes, f.attributes, n))
                                        }
                                else s.retain(u.default.length(i.next()));
                                return s.chop()
                                ...
                                for (var n = u.default.iterator(this.ops), r = 0; n.hasNext() && r <= t;) {
                                    var i = n.peekLength(),
                                        o = n.peekType();
                                    n.next(), "delete" !== o ? ("insert" === o && (r < t || !e) && (t += i), r += i) : t -= Math.min(i, t - r)
                                }
                                return t
                    ...
                    var o, s = r,
                        a = function() {
                            ...
                            return t.prototype.append = function() {
                                ...
                                if (!(e <= 0))
                                    for (var r = this.find(t), i = r[0], o = t - r[1], s = this.iterator(i), a = s(); a && o < t + e;) {
                                        var u = a.length();
                                        t > o ? n(a, t - o, Math.min(e, o + u - t)) : n(a, 0, Math.min(u, t + e - o)), o += u, a = s()
                                    }
                            }, t.prototype.map = function(t) {
                        ...
                        f = function() {
                            ...
                            return t.find = function(t, e) {
                                ...
                                var i = this.query(n);
                                if (null == i) throw new l("Unable to create " + n + " blot");
                                var o = i,
                                    s = n instanceof Node || n.nodeType === Node.TEXT_NODE ? n : o.create(r),
                                    a = new o(e, s, r);
                        ...
                        p = function() {
                            ...
                            return t.create = function(t) {
                                ...
                                if (null != this.scroll.query(n, s.BLOT) && r) i.wrap(n, r);
                                else if (null != this.scroll.query(n, s.ATTRIBUTE)) {
                                    var o = this.scroll.create(this.statics.scope);
                                    i.wrap(o), o.format(n, r)
                                }
                    ...
                    var v = function(t) {
                            ...
                            return d(e, t), e.prototype.appendChild = function(t) {
                                ...
                                return this.children.forEachAt(n, r, (function(n, r, s) {
                                    (null == t.blotName && t(n) || null != t.blotName && n instanceof t) && i.push(n), n instanceof e && (i = i.concat(n.descendants(t, r, o))), o -= s
                                })), i
                                ...
                                return i instanceof e ? s.concat(i.path(o, n)) : (null != i && s.push([i, o]), s)
                            }, e.prototype.removeChild = function(t) {
                                this.children.remove(t)
                            }, e.prototype.replaceWith = function(n, r) {
                                var i = "string" == typeof n ? this.scroll.create(n, r) : n;
                                return i instanceof e && this.moveChildren(i), t.prototype.replaceWith.call(this, i)
                                ...
                                var n = this.clone();
                                return this.parent && this.parent.insertBefore(n, this.next || void 0), this.children.forEachAt(t, this.length(), (function(t, r, i) {
                                    var o = t.split(r, e);
                                    null != o && n.appendChild(o)
                                })), n
                        ...
                        b = function(t) {
                            ...
                            }, e.prototype.formatAt = function(e, n, r, i) {
                                t.prototype.formatAt.call(this, e, n, r, i), this.enforceAllowedChildren()
                    ...
                    var x = function(t) {
                            ...
                            return t.prototype.attribute = function(t, e) {
                                ...
                                if (null != e) {
                                    var n = T.keys(this.domNode),
                                        ...
                                        i = P.keys(this.domNode);
                                    n.concat(r).concat(i).forEach((function(n) {
                        ...
                        k = function(t) {
                            ...
                            return L(e, t), e.formats = function(t, n) {
                                ...
                                if (t !== this.statics.blotName || n) {
                                    var i = this.scroll.query(t, s.INLINE);
                                    if (null == i) return;
                                    i instanceof T ? this.attributes.attribute(i, n) : !n || t === this.statics.blotName && this.formats()[t] === n || this.replaceWith(t, n)
                                ...
                                null != this.formats()[r] || this.scroll.query(r, s.ATTRIBUTE) ? this.isolate(e, n).format(r, i) : t.prototype.formatAt.call(this, e, n, r, i)
                            }, e.prototype.optimize = function(n) {
                                t.prototype.optimize.call(this, n);
                                var r = this.formats();
                                if (0 === Object.keys(r).length) return this.unwrap();
                                var i = this.next;
                                i instanceof e && i.prev === this && function(t, e) {
                                ...
                                var i = t.prototype.wrap.call(this, n, r);
                                return i instanceof e && this.attributes.move(i), i
                        ...
                        j = function(t) {
                            ...
                            return I(e, t), e.formats = function(t, n) {
                                ...
                                null != this.scroll.query(r, s.BLOCK) ? this.format(r, i) : t.prototype.formatAt.call(this, e, n, r, i)
                            }, e.prototype.insertAt = function(e, n, r) {
                        ...
                        M = function(t) {
                            ...
                            return B(e, t), e.formats = function(t, e) {}, e.prototype.format = function(e, n) {
                                ...
                                0 === e && n === this.length() ? this.format(r, i) : t.prototype.formatAt.call(this, e, n, r, i)
                            }, e.prototype.formats = function() {
                        ...
                        H = function(t) {
                            ...
                            return F(e, t), e.prototype.create = function(t, e) {
                                ...
                                this.update(), t.prototype.formatAt.call(this, e, n, r, i)
                            }, e.prototype.insertAt = function(e, n, r) {
                                ...
                                for (var i = n.mutationsMap || new WeakMap, o = Array.from(this.observer.takeRecords()); o.length > 0;) e.push(o.pop());
                                for (var s = function(t, e) {
                                        void 0 === e && (e = !0), null != t && t !== r && null != t.domNode.parentNode && (i.has(t.domNode) || i.set(t.domNode, []), e && s(t.parent))
                                    }, a = function(t) {
                                        i.has(t.domNode) && (t instanceof v && t.children.forEach(a), i.delete(t.domNode), t.optimize(n))
                                    ...
                                    for (u.forEach((function(t) {
                                        ...
                                        })), this.children.forEach(a), o = (u = Array.from(this.observer.takeRecords())).slice(); o.length > 0;) e.push(o.pop())
                                }
                            }, e.prototype.update = function(e, n) {
                                var r = this;
                                ...
                                e.map((function(t) {
                                    var e = r.find(t.target, !0);
                                    return null == e ? null : i.has(e.domNode) ? (i.get(e.domNode).push(t), null) : (i.set(e.domNode, [t]), e)
                                })).forEach((function(t) {
                                    null != t && t !== r && i.has(t.domNode) && t.update(i.get(t.domNode) || [], n)
                                })), n.mutationsMap = i, i.has(this.domNode) && t.prototype.update.call(this, i.get(this.domNode), n), this.optimize(e, n)
                    ...
                    var d = function(t) {
                        ...
                        function o() {
                            ...
                            return function(t, e) {
                                if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
                            }(this, o), (t = i.call(this)).listeners = {}, t.on("error", p.error), t
                        }
                        return e = o, n = [{
                            key: "emit",
                            value: function() {
                                for (var t, e, n = arguments.length, r = new Array(n), i = 0; i < n; i++) r[i] = arguments[i];
                                (t = p.log).call.apply(t, [p].concat(r)), (e = c(h(o.prototype), "emit", this)).call.apply(e, [this].concat(r))
                            }
                        }, {
                            key: "handleDOM",
                            value: function(t) {
                    ...
                    var w = function(t) {
                        ...
                        function n(t, r) {
                            var i;
                            return p(this, n), (i = e.call(this, t, r)).cache = {}, i
                        }
                        return y(n, [{
                            key: "delta",
                            value: function() {
                            ...
                            value: function(t, e, r, i) {
                                e <= 0 || (this.scroll.query(r, o.Scope.BLOCK) ? t + e === this.length() && this.format(r, i) : v(E(n.prototype), "formatAt", this).call(this, t, Math.min(e, this.length() - t - 1), r, i), this.cache = {})
                            }
                        }, {
                            key: "insertAt",
                            value: function(t, e, r) {
                                ...
                                if (0 !== e.length) {
                                    var i = e.split("\n"),
                                        o = i.shift();
                                    o.length > 0 && (t < this.length() - 1 || null == this.children.tail ? v(E(n.prototype), "insertAt", this).call(this, Math.min(t, this.length() - 1), o) : this.children.tail.insertAt(this.children.tail.length(), o), this.cache = {});
                                    var s = this;
                            ...
                            value: function(t) {
                                ...
                                var i = v(E(n.prototype), "split", this).call(this, t, e);
                                return this.cache = {}, i
                            }
                        }]), n
                    }(o.BlockBlot);
                    w.blotName = "block", w.tagName = "P", w.defaultChild = s.a, w.allowedChildren = [s.a, a.a, o.EmbedBlot, u.a];
                    var _ = function(t) {
                        m(n, t);
                        var e = g(n);
                        ...
                        return y(n, [{
                            key: "attach",
                            value: function() {
                                v(E(n.prototype), "attach", this).call(this), this.attributes = new o.AttributorStore(this.domNode)
                            }
                        }, {
                            key: "delta",
                            value: function() {
                                return (new i.a).insert(this.value(), f(f({}, this.formats()), this.attributes.values()))
                            }
                        }, {
                            key: "format",
                            value: function(t, e) {
                                var n = this.scroll.query(t, o.Scope.BLOCK_ATTRIBUTE);
                            ...
                            value: function(t, e, r) {
                                if ("string" == typeof e && e.endsWith("\n")) {
                                    var i = this.scroll.create(w.blotName);
                                    this.parent.insertBefore(i, 0 === t ? this : this.next), i.insertAt(0, e.slice(0, -1))
                    ...
                    function T(t) {
                        var e = !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1];
                        return t.descendants(o.LeafBlot).reduce((function(t, n) {
                        ...
                        S = function() {
                            ...
                            return e = t, n = [{
                                ...
                                value: function(t) {
                                    ...
                                    return r.reduce((function(t, r) {
                                        var o = c.Op.length(r),
                                            ...
                                            a = !1;
                                        if (null != r.insert) {
                                            if (i.retain(o), "string" == typeof r.insert) {
                                                var l = r.insert;
                                                ...
                                                var h = _(e.scroll.line(t), 2),
                                                    ...
                                                    v = u()({}, Object(d.c)(p));
                                                if (p instanceof d.d) {
                                                    var m = _(p.descendant(f.LeafBlot, y), 1)[0];
                                                    v = u()(v, Object(d.c)(m))
                                                }
                                ...
                                value: function(t, e) {
                                    var n = this,
                                        r = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {};
                                    this.scroll.update(), Object.keys(r).forEach((function(i) {
                                        n.scroll.lines(t, Math.max(e, 1)).forEach((function(t) {
                                            t.format(i, r[i])
                                        }))
                                    })), this.scroll.optimize();
                                    var o = (new l.a).retain(t).retain(e, i()(r));
                                ...
                                value: function(t, e) {
                                    var n = _(this.scroll.line(t), 2),
                                        r = n[0],
                                        i = n[1];
                                    return r.length() >= i + e ? C(r, i, e, !0) : C(this.scroll, t, e, !0)
                                }
                            }, {
                                key: "getText",
                                value: function(t, e) {
                                ...
                                value: function(t, e) {
                                    var n = this,
                                        r = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {};
                                    return e = e.replace(/\r\n/g, "\n").replace(/\r/g, "\n"), this.scroll.insertAt(t, e), Object.keys(r).forEach((function(i) {
                                        n.scroll.formatAt(t, e.length, i, r[i])
                                    })), this.update((new l.a).retain(t).insert(e, i()(r)))
                                }
                            }, {
                                key: "isBlank",
                                value: function() {
                                ...
                                value: function(t, e) {
                                    var n = this.getText(t, e),
                                        ...
                                        s = 0,
                                        a = new l.a;
                                    null != i && (s = i.length() - o, a = i.delta().slice(o, o + s - 1).insert("\n"));
                                ...
                                value: function(t) {
                                    ...
                                    if (1 === e.length && "characterData" === e[0].type && e[0].target.data.match(N) && this.scroll.find(e[0].target)) {
                                        var i = this.scroll.find(e[0].target),
                                            o = Object(d.c)(i),
                                            a = i.offset(this.scroll),
                                            u = e[0].oldValue.replace(p.a.CONTENTS, ""),
                                            c = (new l.a).insert(u),
                                            f = (new l.a).insert(i.value()),
                                            h = n && {
                    ...
                    function C(t, e, n) {
                        ...
                        if (t.children) {
                            ...
                            if (t.children.forEachAt(e, n, (function(t, e, n) {
                                    o.push(C(t, e, n))
                                })), r || "list" === t.statics.blotName) return o.join("");
                            var s = t.domNode,
                                a = s.outerHTML,
                                u = s.innerHTML,
                                ...
                                l = c[0],
                                f = c[1];
                            return "<table" === l ? '<table style="border: 1px solid #000;">'.concat(o.join(""), "<").concat(f) : "".concat(l, ">").concat(o.join(""), "<").concat(f)
                        }
                    ...
                    var m = Object(c.a)("quill:selection"),
                        ...
                        g = function() {
                            function t(e, n) {
                                var r = this;
                                v(this, t), this.emitter = n, this.scroll = e, this.composing = !1, this.mouseDown = !1, this.root = this.scroll.domNode, this.cursor = this.scroll.create("cursor", this), this.savedRange = new b(0, 0), this.lastRange = this.savedRange, this.lastNative = null, this.handleComposition(), this.handleDragging(), this.emitter.listenDOM("selectionchange", document, (function() {
                                    ...
                                    if (e.range) {
                                        var n = e.range,
                                            ...
                                            s = n.endNode,
                                            a = n.endOffset;
                                        r.setNativeRange(i, o, s, a), r.update(u.a.sources.SILENT)
                                    }
                            ...
                            return y(t, [{
                                ...
                                value: function(t, e) {
                                    ...
                                    if (null != n && n.native.collapsed && !this.scroll.query(t, r.Scope.BLOCK)) {
                                        if (n.start.node !== this.cursor.textNode) {
                                            var i = this.scroll.find(n.start.node, !1);
                                            if (null == i) return;
                                            if (i instanceof r.LeafBlot) {
                                                var o = i.split(n.start.offset);
                                                i.parent.insertBefore(this.cursor, o)
                                            } else i.insertBefore(this.cursor, n.start.node);
                                            this.cursor.attach()
                                        }
                                ...
                                value: function(t) {
                                    ...
                                    var i = f(this.scroll.leaf(t), 2),
                                        o = i[0],
                                        s = i[1];
                                    if (null == o) return null;
                                    var a = f(o.position(s, !0), 2);
                                    e = a[0], s = a[1];
                                    var u = document.createRange();
                                    if (n > 0) {
                                        u.setStart(e, s);
                                        var c = f(this.scroll.leaf(t + n), 2);
                                        if (o = c[0], s = c[1], null == o) return null;
                                        var l = f(o.position(s, !0), 2);
                                    ...
                                    } else h = o.domNode.getBoundingClientRect(), s > 0 && (p = "right");
                                    return {
                                ...
                                value: function(t) {
                                    ...
                                    var i = n.map((function(t) {
                                            var n = f(t, 2),
                                                ...
                                                s = e.scroll.find(i, !0),
                                                a = s.offset(e.scroll);
                                            return 0 === o ? a : s instanceof r.ContainerBlot ? a + s.length() : a + s.index(i, o)
                                        })),
                                    ...
                                    if (null != e) {
                                        ...
                                        if (null != n) {
                                            var r = this.scroll.length() - 1,
                                                i = f(this.scroll.line(Math.min(e.index, r)), 1)[0],
                                                o = i;
                                            if (e.length > 0 && (o = f(this.scroll.line(Math.min(e.index + e.length, r)), 1)[0]), null != i && null != o) {
                                        ...
                                        if (null != o)
                                            if (null != t) {
                                                ...
                                                if (null == s || i || t !== s.startContainer || e !== s.startOffset || n !== s.endContainer || r !== s.endOffset) {
                                                    ...
                                                    a.setStart(t, e), a.setEnd(n, r), o.removeAllRanges(), o.addRange(a)
                                                }
                                ...
                                value: function() {
                                    var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : u.a.sources.USER,
                                        ...
                                        r = n[0],
                                        i = n[1];
                                    if (this.lastRange = r, this.lastNative = i, null != this.lastRange && (this.savedRange = this.lastRange), !a()(e, this.lastRange)) {
                                        var s;
                                        ...
                                        var l, h = [u.a.events.SELECTION_CHANGE, o()(this.lastRange), o()(e), t];
                    ...
                    var u = function(t) {
                        ...
                        return e = u, n && i(e.prototype, n), r && i(e, r), Object.defineProperty(e, "prototype", {
                            writable: !1
                        }), e
                    }(n(2).TextBlot);
                    ...
                    (function(t, n) {
                        var r = "__lodash_hash_undefined__",
                            ...
                            L = /^(?:0|[1-9]\d*)$/,
                            k = {};
                        k[o] = k["[object Array]"] = k[g] = k[E] = k[s] = k[a] = k[w] = k[_] = k[T] = k[A] = k[O] = k[l] = k[f] = k[h] = k[d] = k[y] = k[v] = k[m] = k[x] = k[R] = k[N] = k[S] = !0, k["[object Error]"] = k[u] = k[b] = !1;
                        ...
                        function Pt(t, e) {
                            var n = zt(t) || function(t) {
                                ...
                                r = n.length,
                                i = !!r;
                            for (var s in t) !e && !tt.call(t, s) || i && ("length" == s || Ht(s, r)) || n.push(s);
                            return n
                        }
                        ...
                        function kt(t, e, n, r, i, p, b) {
                            var C;
                            if (r && (C = p ? r(t, i, p, b) : r(t)), void 0 !== C) return C;
                            if (!Zt(t)) return t;
                            var L = zt(t);
                            if (L) {
                                if (C = function(t) {
                            ...
                            return function(t, e) {
                                ...
                                M && (i = t[o = i]), Ct(C, o, kt(i, e, n, r, o, t, b))
                            })), C
                        }
                        ...
                        function Ht(t, e) {
                            return !!(e = null == e ? i : e) && ("number" == typeof t || L.test(t)) && t > -1 && t % 1 == 0 && t < e
                        }
                        ...
                        function qt(t, e) {
                            return t === e || t != t && e != e
                        }(pt && Ut(new pt(new ArrayBuffer(1))) != E || dt && Ut(new dt) != l || yt && Ut(yt.resolve()) != p || vt && Ut(new vt) != y || mt && Ut(new mt) != b) && (Ut = function(t) {
                            var e = et.call(t),
                    ...
                    function o(t) {
                        if (r.indexOf(t) <= r.indexOf(i)) {
                            for (var e, n = arguments.length, o = new Array(n > 1 ? n - 1 : 0), s = 1; s < n; s++) o[s - 1] = arguments[s];
                        ...
                        return e = s, i = [{
                            ...
                            value: function(t, e, n, i) {
                                if (s.compare(this.statics.blotName, n) < 0 && this.scroll.query(n, r.Scope.BLOT)) {
                                    ...
                                    i && o.wrap(n, i)
                                } else u(f(s.prototype), "formatAt", this).call(this, t, e, n, i)
                            }
                        }, {
                            key: "optimize",
                            value: function(t) {
                    ...
                    h.allowedChildren = [h, i.a, r.EmbedBlot, o.a], h.order = ["cursor", "inline", "link", "underline", "strike", "italic", "bold", "script", "code"], e.a = h
                }, function(t, e, n) {
                    "use strict";
                    n.d(e, "a", (function() {
                        return w
                    ...
                    w.blotName = "code", w.tagName = "CODE", E.blotName = "code-block", E.className = "ql-code-block", E.tagName = "DIV", g.blotName = "code-block-container", g.className = "ql-code-block-container", g.tagName = "DIV", g.allowedChildren = [E], E.allowedChildren = [a.a, i.a, o.a], E.requiredContainer = g, E.TAB = "  "
                }, function(t, e, n) {
                    "use strict";
                    var r = n(2),
                        i = n(3),
                    ...
                    function m(t) {
                        return t instanceof o.d || t instanceof o.a
                    }
                    var b = function(t) {
                        ! function(t, e) {
                            if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
                        ...
                        function f(t, e, n) {
                            ...
                            return function(t, e) {
                                if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
                            }(this, f), (r = c.call(this, t, e)).defaultUpdateAttributes = void 0, r.emitter = i, r.optimize(), r.enable(), r.domNode.addEventListener("dragstart", (function(t) {
                        ...
                        return e = f, n = [{
                            ...
                            key: "emitMount",
                            value: function(t) {
                                this.emitter.emit(i.a.events.SCROLL_BLOT_MOUNT, t)
                            }
                        }, {
                            key: "emitUnmount",
                            value: function(t) {
                                this.emitter.emit(i.a.events.SCROLL_BLOT_UNMOUNT, t)
                            }
                        }, {
                            key: "deleteAt",
                            value: function(t, e) {
                                ...
                                if (p(v(f.prototype), "deleteAt", this).call(this, t, e), null != a && r !== a && i > 0) {
                                    if (r instanceof o.a || a instanceof o.a) return void this.optimize();
                            ...
                            value: function(t, e, n) {
                                if (t >= this.length())
                                    if (null == n || null == this.scroll.query(e, r.Scope.BLOCK)) {
                                        var i = this.scroll.create(this.statics.defaultChild.blotName);
                                        this.appendChild(i), null == n && e.endsWith("\n") ? i.insertAt(0, e.slice(0, -1), n) : i.insertAt(0, e, n)
                                    } else {
                                        var o = this.scroll.create(e, n);
                                        this.appendChild(o)
                                    }
                            ...
                            value: function(t, e) {
                                if (t.statics.scope === r.Scope.INLINE_BLOT) {
                                    ...
                                    var i = this.defaultUpdateAttributes,
                                        o = i.paraAttributes,
                                        s = i.charAttributes,
                                        a = t.domNode;
                                    a.nodeType === Node.TEXT_NODE && Object.entries(s).forEach((function(t) {
                                        var e = l(t, 2),
                                            r = e[0],
                                            i = e[1];
                                        return n.formatAt(0, a.length, r, i)
                            ...
                            value: function() {
                                return function t(e, n, i) {
                                    ...
                                    return e.children.forEachAt(n, i, (function(e, n, i) {
                                        m(e) ? o.push(e) : e instanceof r.ContainerBlot && (o = o.concat(t(e, n, s))), s -= i
                                    })), o
                            ...
                            value: function() {
                                ...
                                !0 !== this.batch && (p(v(f.prototype), "optimize", this).call(this, t, e), t.length > 0 && this.emitter.emit(i.a.events.SCROLL_OPTIMIZE, t, e))
                            }
                        }, {
                            key: "path",
                            value: function(t) {
                            ...
                            value: function(t) {
                                ...
                                if (!0 !== this.batch) {
                                    ...
                                    t.length > 0 && this.emitter.emit(i.a.events.SCROLL_BEFORE_UPDATE, n, t);
                                    ...
                                    if ((h || d) && (l = t.find((function(t) {
                                        ...
                                        var y, m = l.removedNodes[0],
                                            b = this.registry.find(m);
                                        b && (b instanceof o.d ? y = b.delta() : b.children && b.children.head instanceof o.d && (y = b.children.head.delta()), y && y.eachLine((function(t, n) {
                                    ...
                                    p(v(f.prototype), "update", this).call(this, t.concat([])), t.length > 0 && this.emitter.emit(i.a.events.SCROLL_UPDATE, n, t, d && this.defaultUpdateAttributes ? this.defaultUpdateAttributes.charAttributes : null), this.defaultUpdateAttributes && (this.defaultUpdateAttributes = void 0)
                                }
                            }
                    ...
                    b.blotName = "scroll", b.className = "ql-editor", b.tagName = "DIV", b.defaultChild = o.d, b.allowedChildren = [o.d, o.a, a.a], e.a = b
                }, function(t, e, n) {
                    "use strict";
                        ...
                        return e = h, o = [{
                            ...
                            value: function(t, e) {
                                if (0 === this.savedLength) {
                                    for (var n = this, i = 0; null != n && n.statics.scope !== r.Scope.BLOCK_BLOT;) i += n.offset(n.parent), n = n.parent;
                                    null != n && (this.savedLength = h.CONTENTS.length, n.optimize(), n.formatAt(i, h.CONTENTS.length, t, e), this.savedLength = 0)
                            ...
                            value: function() {
                                ...
                                var e, n = this.prev instanceof i.a ? this.prev : null,
                                    r = n ? n.length() : 0,
                                    o = this.next instanceof i.a ? this.next : null,
                                    s = o ? o.text : "",
                                    a = this.textNode,
                                    u = a.data.split(h.CONTENTS).join("");
                                a.data = h.CONTENTS;
                                var c = !1;
                                if (n) e = n, (u || o) && (n.insertAt(n.length(), u + s), o && o.remove());
                                else if (o) e = o, o.insertAt(0, u);
                                else {
                                ...
                                if (this.remove(), t) {
                                    var f = function(t, e) {
                                            return n && t === n.domNode ? e : t === a ? r + e - 1 : o && t === o.domNode ? r + u.length + e : null
                                        },
                    ...
                    (function(t, n) {
                        var r = "__lodash_hash_undefined__",
                            ...
                            d = /^(?:0|[1-9]\d*)$/,
                            y = {};
                        y["[object Float32Array]"] = y["[object Float64Array]"] = y["[object Int8Array]"] = y["[object Int16Array]"] = y["[object Int32Array]"] = y["[object Uint8Array]"] = y["[object Uint8ClampedArray]"] = y["[object Uint16Array]"] = y["[object Uint32Array]"] = !0, y[o] = y["[object Array]"] = y["[object ArrayBuffer]"] = y["[object Boolean]"] = y["[object DataView]"] = y["[object Date]"] = y["[object Error]"] = y[a] = y["[object Map]"] = y["[object Number]"] = y[l] = y["[object RegExp]"] = y["[object Set]"] = y["[object String]"] = y["[object WeakMap]"] = !1;
                        var v, m, b, g = "object" == typeof t && t && t.Object === Object && t,
                            ...
                            L = S.toString,
                            k = P.hasOwnProperty,
                            I = (v = /[^.]+$/.exec(C && C.keys && C.keys.IE_PROTO || "")) ? "Symbol(src)_1." + v : "",
                            j = P.toString,
                            B = L.call(Object),
                        ...
                        function it(t, e) {
                            var n = xt(t),
                                ...
                                u = a.length;
                            for (var c in t) !e && !k.call(t, c) || s && ("length" == c || i && ("offset" == c || "parent" == c) || o && ("buffer" == c || "byteLength" == c || "byteOffset" == c) || Et(c, u)) || a.push(c);
                            return a
                        }
                        ...
                        tt.prototype.clear = function() {
                            ...
                            var e = this.__data__;
                            return J ? void 0 !== e[t] : k.call(e, t)
                        ...
                        function yt(t, e, n, r, i) {
                            t !== e && lt(e, (function(o, s) {
                                if (i || (i = new rt), Ct(o)) ! function(t, e, n, r, i, o, s) {
                                    var a = _t(t, n),
                                        u = _t(e, n),
                                        c = s.get(u);
                                    if (c) ot(t, n, c);
                                    else {
                                        var f, h, p, d, y, v = o ? o(a, u, n + "", t, e, s) : void 0,
                                            m = void 0 === v;
                                        if (m) {
                                            var b = xt(u),
                                                g = !b && Nt(u),
                                                E = !b && !g && kt(u);
                                            v = u, b || g || E ? xt(a) ? v = a : Lt(y = a) && Rt(y) ? v = function(t, e) {
                                                var n = -1,
                                                    r = t.length;
                                                for (e || (e = Array(r)); ++n < r;) e[n] = t[n];
                                                return e
                                            }(a) : g ? (m = !1, v = function(t, e) {
                                                if (e) return t.slice();
                                                var n = t.length,
                                                    r = H ? H(n) : new t.constructor(n);
                                                return t.copy(r), r
                                            }(u, !0)) : E ? (m = !1, p = (f = u).buffer, d = new p.constructor(p.byteLength), new U(d).set(new U(p)), h = d, v = new f.constructor(h, f.byteOffset, f.length)) : v = [] : function(t) {
                                                if (!Lt(t) || ft(t) != l) return !1;
                                                var e = G(t);
                                                if (null === e) return !0;
                                                var n = k.call(e, "constructor") && e.constructor;
                                                return "function" == typeof n && n instanceof n && L.call(n) == B
                                            }(u) || Ot(u) ? (v = a, Ot(a) ? v = function(t) {
                                                return function(t, e, n, r) {
                                                    var i = !n;
                                                    n || (n = {});
                                                    for (var o = -1, s = e.length; ++o < s;) {
                                                        ...
                                                        void 0 === u && (u = t[a]), i ? ut(n, a, u) : st(n, a, u)
                                                    }
                                                    return n
                                                }(t, It(t))
                                        ...
                                        m && (s.set(u, v), i(v, u, r, o, s), s.delete(u)), ot(t, n, v)
                                    }
                                }(t, e, s, n, yt, r, i);
                                else {
                                    var a = r ? r(_t(t, s), o, s + "", t, e, i) : void 0;
                        ...
                        function vt(t, e) {
                            return Tt(function(t, e, n) {
                                return e = Z(void 0 === e ? t.length - 1 : e, 0),
                                    function() {
                                        for (var r = arguments, i = -1, o = Z(r.length - e, 0), s = Array(o); ++i < o;) s[i] = r[e + i];
                                        i = -1;
                        ...
                        var jt, Bt = (jt = function(t, e, n) {
                            ...
                            var n = -1,
                                ...
                                i = r > 1 ? e[r - 1] : void 0,
                                o = r > 2 ? e[2] : void 0;
                            for (i = jt.length > 3 && "function" == typeof i ? (r--, i) : void 0, o && function(t, e, n) {
                                    if (!Ct(n)) return !1;
                                    var r = typeof e;
                    ...
                    (function(t, n) {
                        var r = "__lodash_hash_undefined__",
                            ...
                            P = /^(?:0|[1-9]\d*)$/,
                            C = {};
                        C["[object Float32Array]"] = C["[object Float64Array]"] = C["[object Int8Array]"] = C["[object Int16Array]"] = C["[object Int32Array]"] = C["[object Uint8Array]"] = C["[object Uint8ClampedArray]"] = C["[object Uint16Array]"] = C["[object Uint32Array]"] = !0, C[a] = C[u] = C[R] = C[l] = C[N] = C[f] = C[h] = C[p] = C[y] = C[v] = C[b] = C[w] = C[_] = C[T] = C[x] = !1;
                        ...
                        function St(t, e) {
                            var n = Wt(t),
                                ...
                                u = a.length;
                            for (var c in t) !e && !J.call(t, c) || s && ("length" == c || i && ("offset" == c || "parent" == c) || o && ("buffer" == c || "byteLength" == c || "byteOffset" == c) || Gt(c, u)) || a.push(c);
                            return a
                        }
                        ...
                        function Ct(t) {
                            return null == t ? void 0 === t ? O : m : at && at in Object(t) ? function(t) {
                                var e = J.call(t, at),
                                    n = t[at];
                                try {
                                    t[at] = void 0;
                        ...
                        function kt(t, e, n, r, s) {
                            return t === e || (null == t || null == e || !$t(t) && !$t(e) ? t != t && e != e : function(t, e, n, r, s, c) {
                                ...
                                if (x && !E) return c || (c = new Nt), p || Jt(t) ? Bt(t, e, n, r, s, c) : function(t, e, n, r, s, a, u) {
                                    switch (n) {
                                        case N:
                                ...
                                return !!x && (c || (c = new Nt), function(t, e, n, r, o, s) {
                                    var a = n & i,
                                        u = Mt(t),
                                        c = u.length,
                                        l = Mt(e),
                        ...
                        function jt(t) {
                            ...
                            var e, n, r, i = [];
                            for (var o in Object(t)) J.call(t, o) && "constructor" != o && i.push(o);
                            return i
                        }
                        ...
                        function Bt(t, e, n, r, s, a) {
                            ...
                            for (a.set(t, e), a.set(e, t); ++h < c;) {
                                var y = t[h],
                                    v = e[h];
                                if (r) var m = u ? r(v, y, h, e, t, a) : r(y, v, h, t, e, a);
                                if (void 0 !== m) {
                                    if (m) continue;
                                    p = !1;
                                    break
                                ...
                                if (d) {
                                    if (!H(e, (function(t, e) {
                                            if (i = e, !d.has(i) && (y === t || s(y, t, n, r, a))) return d.push(e);
                                            var i
                                        }))) {
                                        p = !1;
                                        break
                        ...
                        function qt(t, e) {
                            return t === e || t != t && e != e
                        }(ft && Ht(new ft(new ArrayBuffer(1))) != N || ht && Ht(new ht) != y || pt && Ht(pt.resolve()) != g || dt && Ht(new dt) != _ || yt && Ht(new yt) != x) && (Ht = function(t) {
                            var e = Ct(t),
                        ...
                        var zt = Lt(function() {
                                ...
                                return $t(t) && J.call(t, "callee") && !ot.call(t, "callee")
                            },
                            Wt = Array.isArray,
                            Xt = ct || function() {
                                return !1
                    ...
                    var T = Object(f.a)("quill:keyboard"),
                        ...
                        O = function(t) {
                            ...
                            function o(t, e) {
                                ...
                                return function(t, e) {
                                    if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
                                }(this, o), (n = i.call(this, t, e)).bindings = {}, Object.keys(n.options.bindings).forEach((function(t) {
                            ...
                            return e = o, n = [{
                                ...
                                value: function(t) {
                                    var e = this,
                                        ...
                                        r = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {},
                                        i = P(t);
                                    null != i ? ("function" == typeof n && (n = {
                                        handler: n
                                    }), "function" == typeof r && (r = {
                                        handler: r
                                    }), (Array.isArray(i.key) ? i.key : [i.key]).forEach((function(t) {
                                        var o = m(m(m({}, i), {}, {
                                            key: t
                                        }, n), r);
                                        e.bindings[o.key] = e.bindings[o.key] || [], e.bindings[o.key].push(o)
                                    }))) : T.warn("Attempted to add invalid keyboard binding", i)
                                }
                            }, {
                                key: "listen",
                                value: function() {
                                    ...
                                    this.quill.root.addEventListener("keydown", (function(e) {
                                        ...
                                        if (!e.defaultPrevented && !r) {
                                            var i = (t.bindings[e.key] || []).concat(t.bindings[e.which] || []).filter((function(t) {
                                                return o.match(e, t)
                                            }));
                                            if (0 !== i.length) {
                                                ...
                                                if (null != a && t.quill.hasFocus()) {
                                                    var u = d(t.quill.getLine(a.index), 2),
                                                        ...
                                                        y = h[0],
                                                        v = h[1],
                                                        m = d(0 === a.length ? [y, v] : t.quill.getLeaf(a.index + a.length), 2),
                                                        b = m[0],
                                                        g = m[1],
                                ...
                                value: function(t, e) {
                                    ...
                                    if (!(0 === t.index || this.quill.getLength() <= 1)) {
                                        var r = {},
                                            i = d(this.quill.getLine(t.index), 1)[0],
                                            o = (new u.a).retain(t.index - n).delete(n);
                                        if (0 === e.offset) {
                                            ...
                                            if (s && !("block" === s.statics.blotName && s.length() <= 1)) {
                                                ...
                                                if (r = a.AttributeMap.diff(c, f) || {}, Object.keys(r).length > 0) {
                                                    var h = (new u.a).retain(t.index + i.length() - 2).retain(1, r);
                                                    o = o.compose(h)
                                                }
                                            }
                                        }
                                        this.quill.updateContents(o, l.a.sources.USER), this.quill.focus()
                                    }
                                }
                            }, {
                                key: "handleDelete",
                                value: function(t, e) {
                                    ...
                                    if (!(t.index >= this.quill.getLength() - n)) {
                                        var r = {},
                                            i = d(this.quill.getLine(t.index), 1)[0],
                                            o = (new u.a).retain(t.index).delete(n);
                                        if (e.offset >= i.length() - 1) {
                                            var s = d(this.quill.getLine(t.index + 1), 1)[0];
                                            if (s) {
                                                var c = i.formats(),
                                                    f = this.quill.getFormat(t.index, 1);
                                                r = a.AttributeMap.diff(c, f) || {}, Object.keys(r).length > 0 && (o = o.retain(s.length() - 1).retain(1, r))
                                            }
                                        }
                                        this.quill.updateContents(o, l.a.sources.USER), this.quill.focus()
                                    }
                                ...
                                value: function(t, e) {
                                    var n = this,
                                        ...
                                        i = (new u.a).retain(t.index).delete(t.length).insert("\n", r);
                                    this.quill.updateContents(i, l.a.sources.USER), this.quill.setSelection(t.index + 1, l.a.sources.SILENT), this.quill.focus(), Object.keys(e.format).forEach((function(t) {
                        ...
                        return {
                            ...
                            handler: function(e) {
                                ...
                                r.forEach((function(e, r) {
                                    t ? (e.insertAt(0, n.TAB), 0 === r ? i += n.TAB.length : o += n.TAB.length) : e.domNode.textContent.startsWith(n.TAB) && (e.deleteAt(0, n.TAB.length), 0 === r ? i -= n.TAB.length : o -= n.TAB.length)
                                })), this.quill.update(l.a.sources.USER), this.quill.setSelection(i, o, l.a.sources.SILENT)
                            }
                        }
                    }
                            ...
                            handler: function(e, n) {
                                ...
                                if (null != o) {
                                    if ("table-row" === o.statics.blotName) {
                                        for (var s = o.children.head, a = i; null != a.prev;) a = a.prev, s = s.next;
                    ...
                    function C(t) {
                        ...
                        if (r.length > 1) {
                            ...
                            i = a.AttributeMap.diff(s, o) || {}
                        }
                        e.deleteText(n, l.a.sources.USER), Object.keys(i).length > 0 && e.formatLine(n.index, 1, i, l.a.sources.USER), e.setSelection(n.index, l.a.sources.SILENT)
                    }
                    O.DEFAULTS = {
                        bindings: {
                            bold: N("bold"),
                            ...
                            "checklist enter": {
                                ...
                                handler: function(t) {
                                    var e = d(this.quill.getLine(t.index), 2),
                                        ...
                                        o = (new u.a).retain(t.index).insert("\n", i).retain(n.length() - r - 1).retain(1, {
                                            list: "unchecked"
                                        });
                                    this.quill.updateContents(o, l.a.sources.USER), this.quill.setSelection(t.index + 1, l.a.sources.SILENT), this.quill.scrollIntoView()
                                }
                            },
                            "header enter": {
                                key: "Enter",
                            ...
                            "table enter": {
                                ...
                                handler: function(t) {
                                    ...
                                    if (e) {
                                        ...
                                        var o = r.offset();
                                        if (i < 0) {
                                            var s = (new u.a).retain(o).insert("\n");
                                            this.quill.updateContents(s, l.a.sources.USER), this.quill.setSelection(t.index + 1, t.length, l.a.sources.SILENT)
                                        } else if (i > 0) {
                                            o += r.length();
                                            var a = (new u.a).retain(o).insert("\n");
                                            this.quill.updateContents(a, l.a.sources.USER), this.quill.setSelection(o, l.a.sources.USER)
                                        }
                                    }
                                }
                            },
                            "table tab": {
                                ...
                                handler: function(t, e) {
                                    ...
                                    n.shiftKey ? this.quill.setSelection(i - 1, l.a.sources.USER) : this.quill.setSelection(i + r.length(), l.a.sources.USER)
                                }
                            },
                            "list autofill": {
                                key: " ",
                                ...
                                handler: function(t, e) {
                                    ...
                                    var n, r = e.prefix.length,
                                        i = d(this.quill.getLine(t.index), 2),
                                        o = i[0],
                                        s = i[1];
                                    if (s > r) return !0;
                                    ...
                                    var a = (new u.a).retain(t.index - s).delete(r + 1).retain(o.length() - 2 - s).retain(1, {
                                        list: n
                                    });
                            ...
                            "code exit": {
                                ...
                                suffix: /^\s*$/,
                                handler: function(t) {
                                    for (var e = d(this.quill.getLine(t.index), 2), n = e[0], r = e[1], i = 2, o = n; null != o && o.length() <= 1 && o.formats()["code-block"];)
                                        if (o = o.prev, (i -= 1) <= 0) {
                    ...
                    var r = n(2),
                        ...
                        o = new r.Attributor("direction", "dir", i),
                        s = new r.ClassAttributor("direction", "ql-direction", i),
                        a = new r.StyleAttributor("direction", "direction", i)
                }, , function(t, e, n) {
                    "use strict";
                    n.d(e, "a", (function() {
                        return o
                    ...
                    var r = n(2),
                        ...
                        o = new r.Attributor("align", "align", i),
                        s = new r.ClassAttributor("align", "ql-align", i),
                        a = new r.StyleAttributor("align", "text-align", i)
                }, function(t, e, n) {
                    "use strict";
                    e.a = new WeakMap
                }, , , function(t, e, n) {
                    ...
                    var r = n(2),
                        i = n(21),
                        o = new r.ClassAttributor("background", "ql-bg", {
                            scope: r.Scope.INLINE
                        }),
                        s = new i.a("background", "background-color", {
                            scope: r.Scope.INLINE
                        })
                }, function(t, e, n) {
                    "use strict";
                    ...
                    var r = n(2),
                        i = new r.ClassAttributor("size", "ql-size", {
                            scope: r.Scope.INLINE,
                            whitelist: ["small", "large", "huge"]
                        }),
                        o = new r.StyleAttributor("size", "font-size", {
                            scope: r.Scope.INLINE,
                    ...
                    var v = function(t) {
                        ...
                        function n(t, r) {
                            var i;
                            l(this, n), i = e.call(this, t, r);
                            var o = r.ownerDocument.createElement("span"),
                                s = function(e) {
                                    if (t.isEnabled()) {
                                        var n = i.statics.formats(r, t);
                                        "checked" === n ? (i.format("list", "unchecked"), e.preventDefault()) : "unchecked" === n && (i.format("list", "checked"), e.preventDefault())
                                    }
                                };
                            return o.addEventListener("mousedown", s), o.addEventListener("touchstart", s), i.attachUI(o), i
                        }
                        return c(n, [{
                            key: "format",
                            value: function(t, e) {
                    ...
                    var f = function(t) {
                        ...
                        function l(t, e) {
                            ...
                            return function(t, e) {
                                if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
                            }(this, l), (n = o.call(this, t, e)).lastRecorded = 0, n.ignoreChange = !1, n.clear(), n.quill.on(i.a.events.EDITOR_CHANGE, (function(t, e, r, o) {
                                t !== i.a.events.TEXT_CHANGE || n.ignoreChange || (n.options.userOnly && o !== i.a.sources.USER ? n.transform(e) : n.record(e, r))
                            ...
                            value: function(t, e) {
                                if (0 !== this.stack[t].length) {
                                    var n = this.stack[t].pop(),
                                        ...
                                        o = n.invert(r);
                                    this.stack[e].push(o), this.lastRecorded = 0, this.ignoreChange = !0, this.quill.updateContents(n, i.a.sources.USER), this.ignoreChange = !1;
                    ...
                    function h(t, e) {
                        for (var n = e, r = t.length - 1; r >= 0; r -= 1) {
                            var i = t[r];
                            t[r] = n.transform(i, !0), n = i.transform(n), 0 === t[r].length() && t.splice(r, 1)
                        }
                    }
                    ...
                    var T = function(t) {
                        ...
                        function o(t, e) {
                            ...
                            return function(t, e) {
                                if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
                            }(this, o), n = i.call(this, t, e), t.root.addEventListener("drop", (function(e) {
                                var r;
                                if (e.preventDefault(), document.caretRangeFromPoint) r = document.caretRangeFromPoint(e.clientX, e.clientY);
                                    ...
                                    var i = document.caretPositionFromPoint(e.clientX, e.clientY);
                                    (r = document.createRange()).setStart(i.offsetNode, i.offset), r.setEnd(i.offsetNode, i.offset)
                                }
                                var o = t.selection.normalizeNative(r),
                                    s = t.selection.normalizedToRange(o);
                    ...
                    var f = "\ufeff",
                        h = function(t) {
                            ...
                            function h(t, e) {
                                ...
                                return function(t, e) {
                                    if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
                                }(this, h), (n = o.call(this, t, e)).contentNode = document.createElement("span"), n.contentNode.setAttribute("contenteditable", !1), Array.from(n.domNode.childNodes).forEach((function(t) {
                            ...
                            return e = h, (n = [{
                                ...
                                value: function(t) {
                                    ...
                                    else t === this.rightGuard && (this.next instanceof i.a ? (this.next.insertAt(0, r), e = {
                    ...
                    var S = Object(u.a)("quill:clipboard"),
                        P = [
                            ...
                            [Node.ELEMENT_NODE, function(t, e, n) {
                                var r = n.query(t);
                                if (null == r) return e;
                                if (r.prototype instanceof o.EmbedBlot) {
                                    var s = {},
                                        a = r.value(t);
                                    if (null != a) return s[r.blotName] = a, (new i.a).insert(s, r.formats(t, n))
                                } else if (r.prototype instanceof o.BlockBlot && !j(e, "\n") && e.insert("\n"), "function" == typeof r.formats) return I(e, r.blotName, r.formats(t, n));
                                return e
                            }],
                            [Node.ELEMENT_NODE, function(t, e, n) {
                                var r = o.Attributor.keys(t),
                                    i = o.ClassAttributor.keys(t),
                                    s = o.StyleAttributor.keys(t),
                                    a = {};
                                return r.concat(i).concat(s).forEach((function(e) {
                                    var r = n.query(e, o.Scope.ATTRIBUTE);
                            ...
                            [Node.ELEMENT_NODE, function(t, e) {
                                var n = {},
                                    r = t.style || {};
                                return "italic" === r.fontStyle && (n.italic = !0), "underline" === r.textDecoration && (n.underline = !0), "line-through" === r.textDecoration && (n.strike = !0), (r.fontWeight.startsWith("bold") || parseInt(r.fontWeight, 10) >= 700) && (n.bold = !0), Object.keys(n).length > 0 && (e = I(e, n)), parseFloat(r.textIndent || 0) > 0 ? (new i.a).insert("\t").concat(e) : e
                            }],
                            ["li", function(t, e, n) {
                                var r = n.query(t);
                                if (null == r || "list" !== r.blotName || !j(e, "\n")) return e;
                                for (var o = -1, s = t.parentNode; null != s;)["OL", "UL"].includes(s.tagName) && (o += 1), s = s.parentNode;
                        ...
                        k = function(t) {
                            ...
                            function s(t, e) {
                                ...
                                return function(t, e) {
                                    if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
                                }(this, s), (n = o.call(this, t, e)).quill.root.addEventListener("copy", (function(t) {
                            ...
                            return e = s, n = [{
                                ...
                                value: function(t) {
                                    var e = t.html,
                                        n = t.text,
                                        r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
                                    if (r[h.c.blotName]) return (new i.a).insert(n, w({}, h.c.blotName, r[h.c.blotName]));
                                    if (!e) return (new i.a).insert(n || "");
                                    var o = this.convertHTML(e);
                                    return j(o, "\n") && (null == o.ops[o.ops.length - 1].attributes || r.table) ? o.compose((new i.a).retain(o.length() - 1).delete(1)) : o
                                }
                            }, {
                                key: "convertHTML",
                                value: function(t) {
                                    var e = (new DOMParser).parseFromString(t, "text/html").body,
                                        ...
                                        i = r[0],
                                        o = r[1];
                                    return F(this.quill.scroll, e, i, o, n)
                                }
                            }, {
                                ...
                                value: function(t, e) {
                                    ...
                                    if ("string" == typeof t) {
                                        ...
                                        this.quill.updateContents((new i.a).retain(t).concat(o), n), this.quill.setSelection(t + o.length(), a.a.sources.SILENT)
                                    }
                                }
                            }, {
                                key: "onCaptureCopy",
                                    ...
                                    if (!t.defaultPrevented) {
                                        ...
                                        if (null != n) {
                                            var r = this.onCopy(n, e),
                                                i = r.html,
                                                o = r.text;
                                            t.clipboardData.setData("text/plain", o), t.clipboardData.setData("text/html", i), e && Object(m.c)({
                                                range: n,
                                                quill: this.quill
                                            })
                                        }
                                        ...
                                        if (null != e) {
                                            ...
                                            if (!n && i.length > 0) this.quill.uploader.upload(e, i);
                                                ...
                                                if (n && i.length > 0) {
                                                    ...
                                                    if (1 === o.body.childElementCount && "IMG" === o.body.firstElementChild.tagName) return void this.quill.uploader.upload(e, i)
                                                }
                                                this.onPaste(e, {
                                                    html: n,
                                                    text: r
                                ...
                                value: function(t, e) {
                                    ...
                                    var u = (new i.a).retain(t.index).delete(t.length).concat(s);
                    ...
                    function I(t, e, n) {
                        return "object" === E(e) ? Object.keys(e).reduce((function(t, n) {
                            ...
                            var i = n ? w({}, e, n) : {};
                            return t.insert(r.insert, g(g({}, i), r.attributes))
                        }), new i.a)
                    }
                    ...
                    function F(t, e, n, r, o) {
                        return e.nodeType === e.TEXT_NODE ? r.reduce((function(n, r) {
                            return r(e, n, t)
                        }), new i.a) : e.nodeType === e.ELEMENT_NODE ? Array.from(e.childNodes || []).reduce((function(i, s) {
                            var a = F(t, s, n, r, o);
                            return s.nodeType === e.ELEMENT_NODE && (a = n.reduce((function(e, n) {
                                return n(s, e, t)
                            }), a), a = (o.get(s) || []).reduce((function(e, n) {
                                return n(s, e, t)
                            }), a)), i.concat(a)
                        }), new i.a) : new i.a
                    }
                        ...
                        if (!j(e, "\n")) {
                            ...
                            if (e.length() > 0 && t.nextSibling)
                                for (var r = t.nextSibling; null != r;) {
                                    ...
                                    var i = n.query(r);
                                    if (i && i.prototype instanceof s.a) return e.insert("\n");
                                    r = r.firstChild
                                }
                        }
                        return e
                    ...
                    Object.create && (i.prototype = Object.create(null), (new i).__proto__ || (r = !1)), u.prototype.eventNames = function() {
                        ...
                        var e;
                        return t ? (e = r ? r + t : t, this._events[e] && a(this, e)) : (this._events = new i, this._eventsCount = 0), this
                    ...
                    function o(t, e, l, f) {
                            ...
                            var h = function(t, e, n) {
                                ...
                                if (0 === r.length && (null === i || 0 === i.length)) {
                                    ...
                                    if (null === l || l === a) {
                                        ...
                                        if (h === u) {
                                            var m = Math.min(o - y, s - y);
                                            if ((g = c.slice(c.length - m)) === (w = v.slice(v.length - m))) return d(u, c.slice(0, c.length - m), v.slice(0, v.length - m), g)
                                        }
                                    }
                                }
                                if (r.length > 0 && i && 0 === i.length) {
                                    ...
                                    if (!(s < (p = b.length) + (m = g.length))) {
                                        var E = e.slice(0, p),
                                            w = e.slice(s - m);
                                        if (b === E && g === w) return d(b, t.slice(p, o - m), e.slice(p, s - m), g)
                                    }
                                }
                                return null
                            }(t, e, l);
                        ...
                        var v = t.substring(t.length - p),
                            m = function(t, e) {
                                ...
                                var p = function(t, e) {
                                    ...
                                    function i(t, e, n) {
                                        for (var r, i, o, s, c = t.substring(n, n + Math.floor(t.length / 4)), l = -1, f = ""; - 1 !== (l = e.indexOf(c, l + 1));) {
                                            var h = a(t.substring(n), e.substring(l)),
                                                p = u(t.substring(0, n), e.substring(0, l));
                                            f.length < p + h && (f = e.substring(l - p, l) + e.substring(l, l + h), r = t.substring(0, n - p), i = t.substring(n + h), o = e.substring(0, l - p), s = e.substring(l + h))
                                        }
                                        return 2 * f.length >= t.length ? [r, i, o, s, f] : null
                                    }
                                    var o, s, c, l, f, h = i(n, r, Math.ceil(n.length / 4)),
                                        p = i(n, r, Math.ceil(n.length / 2));
                                    if (!h && !p) return null;
                                    o = p ? h && h[4].length > p[4].length ? h : p : h, t.length > e.length ? (s = o[0], c = o[1], l = o[2], f = o[3]) : (l = o[0], f = o[1], s = o[2], c = o[3]);
                                    var d = o[4];
                                    return [s, c, l, f, d]
                                }(t, e);
                                if (p) {
                                ...
                                return function(t, e) {
                                    for (var i = t.length, o = e.length, a = Math.ceil((i + o) / 2), u = a, c = 2 * a, l = new Array(c), f = new Array(c), h = 0; h < c; h++) l[h] = -1, f[h] = -1;
                                    l[u + 1] = 0, f[u + 1] = 0;
                                    for (var p = i - o, d = p % 2 != 0, y = 0, v = 0, m = 0, b = 0, g = 0; g < a; g++) {
                                        for (var E = -g + y; E <= g - v; E += 2) {
                                            for (var w = u + E, _ = (R = E === -g || E !== g && l[w - 1] < l[w + 1] ? l[w + 1] : l[w - 1] + 1) - E; R < i && _ < o && t.charAt(R) === e.charAt(_);) R++, _++;
                                            if (l[w] = R, R > i) v += 2;
                                            else if (_ > o) y += 2;
                                            else if (d && (O = u + p - E) >= 0 && O < c && -1 !== f[O] && R >= (A = i - f[O])) return s(t, e, R, _)
                                        }
                                        for (var T = -g + m; T <= g - b; T += 2) {
                                            for (var A, O = u + T, x = (A = T === -g || T !== g && f[O - 1] < f[O + 1] ? f[O + 1] : f[O - 1] + 1) - T; A < i && x < o && t.charAt(i - A - 1) === e.charAt(o - x - 1);) A++, x++;
                                            if (f[O] = A, A > i) b += 2;
                                            else if (x > o) m += 2;
                                            else if (!d) {
                                                var R;
                                                if ((w = u + p - T) >= 0 && w < c && -1 !== l[w])
                                                    if (_ = u + (R = l[w]) - w, R >= (A = i - A)) return s(t, e, R, _)
                                            }
                                        }
                                    }
                                    return [
                        ...
                        return y && m.unshift([i, y]), v && m.push([i, v]), c(m, f), m
                    }
                    ...
                    function u(t, e) {
                        ...
                        return f(t.charCodeAt(t.length - i)) && i--, i
                    }

                    function c(t, e) {
                        t.push([i, ""]);
                        for (var o, s = 0, l = 0, f = 0, d = "", y = ""; s < t.length;)
                            if (s < t.length - 1 && !t[s][1]) t.splice(s, 1);
                                ...
                                case i:
                                    ...
                                    if (e) {
                                        if (v >= 0 && p(t[v][1])) {
                                            var m = t[v][1].slice(-1);
                                            if (t[v][1] = t[v][1].slice(0, -1), d = m + d, y = m + y, !t[v][1]) {
                                                t.splice(v, 1), s--;
                                                var b = v - 1;
                                                t[b] && t[b][0] === r && (f++, y = t[b][1] + y, b--), t[b] && t[b][0] === n && (l++, d = t[b][1] + d, b--), v = b
                                            }
                                        }
                                        h(t[s][1]) && (m = t[s][1].charAt(0), t[s][1] = t[s][1].slice(1), d += m, y += m)
                                    }
                                    ...
                                    if (d.length > 0 || y.length > 0) {
                                        d.length > 0 && y.length > 0 && (0 !== (o = a(y, d)) && (v >= 0 ? t[v][1] += y.substring(0, o) : (t.splice(0, 0, [i, y.substring(0, o)]), s++), y = y.substring(o), d = d.substring(o)), 0 !== (o = u(y, d)) && (t[s][1] = y.substring(y.length - o) + t[s][1], y = y.substring(0, y.length - o), d = d.substring(0, d.length - o)));
                                        var g = f + l;
                                    ...
                                    0 !== s && t[s - 1][0] === i ? (t[s - 1][1] += t[s][1], t.splice(s, 1)) : s++, f = 0, l = 0, d = "", y = ""
                            }
                        "" === t[t.length - 1][1] && t.pop();
                        var E = !1;
                        for (s = 1; s < t.length - 1;) t[s - 1][0] === i && t[s + 1][0] === i && (t[s][1].substring(t[s][1].length - t[s - 1][1].length) === t[s - 1][1] ? (t[s][1] = t[s - 1][1] + t[s][1].substring(0, t[s][1].length - t[s - 1][1].length), t[s + 1][1] = t[s - 1][1] + t[s + 1][1], t.splice(s - 1, 1), E = !0) : t[s][1].substring(0, t[s + 1][1].length) == t[s + 1][1] && (t[s - 1][1] += t[s + 1][1], t[s][1] = t[s][1].substring(t[s + 1][1].length) + t[s + 1][1], t.splice(s + 1, 1), E = !0)), s++;
                        E && c(t, e)
                    }
                    ...
                    y.INSERT = r, y.DELETE = n, y.EQUAL = i, t.exports = y
                }, function(t, e, n) {
                    "use strict";
                    var r = this && this.__importDefault || function(t) {
                        return t && t.__esModule ? t : {
        ...
        264100: (t, e, n) => {
            ...
            function o(t) {
                ...
                var n, i = t.language;
                return "root" !== i && (n = t.maximize().region), (r._[n || ""] || r._[i || ""] || r._["".concat(i, "-001")] || r._["001"])[0]
            }
        },
        853219: (t, e, n) => {
            "use strict";
        ...
        363014: (t, e, n) => {
            ...
            function u(t, e) {
                ...
                var n = new o._(t, e).parse();
                if (n.err) {
                    var s = SyntaxError(i.o[n.err.kind]);
        ...
        655697: (t, e, n) => {
            ...
            var _, T = d ? function(t, e, n) {
                ...
                A = y ? String.fromCodePoint : function() {
                    for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
                ...
                O = v ? Object.fromEntries : function(t) {
            ...
            var C = function() {
                ...
                return t.prototype.parse = function() {
                    ...
                    for (var r = []; !this.isEOF();) {
                        ...
                        if (123 === i) {
                            ...
                            if (35 !== i || "plural" !== e && "selectordinal" !== e) {
                                ...
                                if (60 === i && !this.ignoreTag && L(this.peek() || 0)) {
                    ...
                    if (this.bumpIf(">")) {
                        ...
                        if (this.bumpIf("</")) {
                            if (this.isEOF() || !L(this.char())) return this.error(o.o.INVALID_TAG, p(u, this.clonePosition()));
                            var c = this.clonePosition();
                            return r !== this.parseTagName() ? this.error(o.o.UNMATCHED_CLOSING_TAG, p(c, this.clonePosition())) : (this.bumpSpace(), this.bumpIf(">") ? {
                                val: {
                                    type: s.wD.tag,
                                    value: r,
                                    children: a,
                        ...
                        return this.error(o.o.UNCLOSED_TAG, p(n, this.clonePosition()))
                    }
                    return this.error(o.o.INVALID_TAG, p(n, this.clonePosition()))
                    ...
                    var n = this.clonePosition();
                    if (this.bump(), this.bumpSpace(), this.isEOF()) return this.error(o.o.EXPECT_ARGUMENT_CLOSING_BRACE, p(n, this.clonePosition()));
                    if (125 === this.char()) return this.bump(), this.error(o.o.EMPTY_ARGUMENT, p(n, this.clonePosition()));
                    var r = this.parseIdentifierIfPossible().value;
                    if (!r) return this.error(o.o.MALFORMED_ARGUMENT, p(n, this.clonePosition()));
                    if (this.bumpSpace(), this.isEOF()) return this.error(o.o.EXPECT_ARGUMENT_CLOSING_BRACE, p(n, this.clonePosition()));
                    switch (this.char()) {
                        case 125:
                            return this.bump(), {
                                val: {
                        ...
                        case 44:
                            return this.bump(), this.bumpSpace(), this.isEOF() ? this.error(o.o.EXPECT_ARGUMENT_CLOSING_BRACE, p(n, this.clonePosition())) : this.parseArgumentOptions(t, e, r, n);
                        default:
                            return this.error(o.o.MALFORMED_ARGUMENT, p(n, this.clonePosition()))
                    }
                    ...
                    switch (f) {
                        case "":
                            return this.error(o.o.EXPECT_ARGUMENT_TYPE, p(c, h));
                        case "number":
                        case "date":
                        case "time":
                            this.bumpSpace();
                            ...
                            if (this.bumpIf(",")) {
                                ...
                                if (0 === (g = N(A.val)).length) return this.error(o.o.EXPECT_ARGUMENT_STYLE, p(this.clonePosition(), this.clonePosition()));
                                d = {
                                    style: g,
                            ...
                            if (d && T(null == d ? void 0 : d.style, "::", 0)) {
                                ...
                                if (0 === m.length) return this.error(o.o.EXPECT_DATE_TIME_SKELETON, v);
                                var b = m;
                        ...
                        case "select":
                            ...
                            if ("select" !== f && "offset" === w.value) {
                                ...
                                var A;
                                if (this.bumpSpace(), (A = this.tryParseDecimalInteger(o.o.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE, o.o.INVALID_PLURAL_ARGUMENT_OFFSET_VALUE)).err) return A;
                        ...
                        default:
                            return this.error(o.o.INVALID_ARGUMENT_TYPE, p(c, h))
                    }
                    ...
                    for (var t = 0, e = this.clonePosition(); !this.isEOF();) {
                        switch (this.char()) {
                            case 39:
                                this.bump();
                                var n = this.clonePosition();
                                if (!this.bumpUntil("'")) return this.error(o.o.UNCLOSED_QUOTE_IN_ARGUMENT_STYLE, p(n, this.clonePosition()));
                                this.bump();
                                break;
                            case 123:
                                t += 1, this.bump();
                    ...
                    for (var i, s = !1, a = [], u = new Set, c = r.value, l = r.location;;) {
                        if (0 === c.length) {
                            var f = this.clonePosition();
                            if ("select" === e || !this.bumpIf("=")) break;
                            var h = this.tryParseDecimalInteger(o.o.EXPECT_PLURAL_ARGUMENT_SELECTOR, o.o.INVALID_PLURAL_ARGUMENT_SELECTOR);
                            if (h.err) return h;
                            l = p(f, this.clonePosition()), c = this.message.slice(f.offset, this.offset())
                        }
                        if (u.has(c)) return this.error("select" === e ? o.o.DUPLICATE_SELECT_ARGUMENT_SELECTOR : o.o.DUPLICATE_PLURAL_ARGUMENT_SELECTOR, l);
                    ...
                    return 0 === a.length ? this.error("select" === e ? o.o.EXPECT_SELECT_ARGUMENT_SELECTOR : o.o.EXPECT_PLURAL_ARGUMENT_SELECTOR, p(this.clonePosition(), this.clonePosition())) : this.requiresOtherClause && !s ? this.error(o.o.MISSING_OTHER_CLAUSE, p(this.clonePosition(), this.clonePosition())) : {
                        val: a,
                        err: null
                    }
        ...
        989558: (t, e, n) => {
            ...
            function o(t) {
                ...
                for (var e = [], n = 0, r = t.split(i.r).filter((function(t) {
                        return t.length > 0
                    })); n < r.length; n++) {
                    var o = r[n].split("/");
                    if (0 === o.length) throw new Error("Invalid number skeleton");
                    for (var s = o[0], a = o.slice(1), u = 0, c = a; u < c.length; u++) {
                ...
                for (var e = {}, n = 0, i = t; n < i.length; n++) {
                    ...
                    switch (o.stem) {
                        ...
                        case "integer-width":
                            ...
                            o.options[0].replace(u, (function(t, n, r, i, o, s) {
                    ...
                    } else if (a.test(o.stem)) e = (0, r.pi)((0, r.pi)({}, e), l(o.stem));
                    else {
                        var y = f(o.stem);
        ...
        172931: (t, e, n) => {
            ...
            function l(t, e, n, o) {
                ...
                return n && (s.key = n), o ? s.pathname ? "/" !== s.pathname.charAt(0) && (s.pathname = (0, i.Z)(s.pathname, o.pathname)) : s.pathname = o.pathname : s.pathname || (s.pathname = "/"), s
            }
            ...
            function m(t) {
                ...
                function F(t) {
                    1 === (D += t) && 1 === t ? (window.addEventListener(d, P), m && window.addEventListener(y, C)) : 0 === D && (window.removeEventListener(d, P), m && window.removeEventListener(y, C))
                }
                var U = !1;
                var H = {
                    length: n.length,
                    ...
                    push: function(t, e) {
                        var r = "PUSH",
                            o = l(t, e, R(), H.location);
                        N.confirmTransitionTo(o, r, _, (function(t) {
                            if (t) {
                                var e = B(o),
                                    s = o.key,
                                    a = o.state;
                            ...
                            if (t) {
                                ...
                                if (i)
                                    if (n.replaceState({
                                        ...
                                        var u = j.indexOf(H.location.key); - 1 !== u && (j[u] = o.key), S({
                                            action: r,
                                            location: o
                                        })
                                    }
        ...
        33976: (t, e, n) => {
            ...
            function a(t, e) {
                return e ? Object.keys(t).reduce((function(n, i) {
                    var o, s;
                    return n[i] = (o = t[i], (s = e[i]) ? (0, r.pi)((0, r.pi)((0, r.pi)({}, o || {}), s || {}), Object.keys(o).reduce((function(t, e) {
                        return t[e] = (0, r.pi)((0, r.pi)({}, o[e]), s[e] || {}), t
                    }), {})) : o), n
                }), (0, r.pi)({}, t)) : t
            }
            ...
            var c = function() {
                function t(e, n, i, c) {
                    ...
                    this.formats = a(t.formats, i), this.formatters = c && c.formatters || (void 0 === (l = this.formatterCache) && (l = {
                        number: {},
                        dateTime: {},
                        pluralRules: {}
                    }), {
        ...
        953836: (t, e, n) => {
            ...
            var o = function(t) {
                ...
                s = function(t) {
                    function e(e, n, i, o) {
                        return t.call(this, 'Invalid values for "'.concat(e, '": "').concat(n, '". Options are "').concat(Object.keys(i).join('", "'), '"'), r.INVALID_VALUE, o) || this
                    }
                    return (0, i.ZT)(e, t), e
                }(o),
                a = function(t) {
                    function e(e, n, i) {
                        return t.call(this, 'Value for "'.concat(e, '" must be of type ').concat(n), r.INVALID_VALUE, i) || this
                    }
                    return (0, i.ZT)(e, t), e
                }(o),
                u = function(t) {
        ...
        15810: (t, e, n) => {
            ...
            function a(t, e, n, u, c, l, f) {
                ...
                for (var h = [], p = 0, d = t; p < d.length; p++) {
                    ...
                    else if ((0, i.yx)(y)) "number" == typeof l && h.push({
                        type: r.literal,
                        value: n.getNumberFormat(e).format(l)
                    });
                    else {
                        var v = y.value;
                        if (!c || !(v in c)) throw new o.HR(v, f);
                        var m = c[v];
                        if ((0, i.VG)(y)) m && "string" != typeof m && "number" != typeof m || (m = "string" == typeof m || "number" == typeof m ? String(m) : ""), h.push({
                            type: "string" == typeof m ? r.literal : r.object,
                            value: m
                        });
                        else if ((0, i.rp)(y)) {
                            var b = "string" == typeof y.style ? u.date[y.style] : (0, i.Ii)(y.style) ? y.style.parsedOptions : void 0;
                            h.push({
                                type: r.literal,
                                value: n.getDateTimeFormat(e, b).format(m)
                            })
                        } else if ((0, i.pe)(y)) {
                            b = "string" == typeof y.style ? u.time[y.style] : (0, i.Ii)(y.style) ? y.style.parsedOptions : u.time.medium;
                            h.push({
                                type: r.literal,
                                value: n.getDateTimeFormat(e, b).format(m)
                            })
                        } else if ((0, i.uf)(y)) {
                            (b = "string" == typeof y.style ? u.number[y.style] : (0, i.Wh)(y.style) ? y.style.parsedOptions : void 0) && b.scale && (m *= b.scale || 1), h.push({
                                type: r.literal,
                            ...
                            if ((0, i.HI)(y)) {
                                var g = y.children,
                                    E = y.value,
                                    w = c[E];
                                if (!s(w)) throw new o.YR(E, "function", f);
                            ...
                            if ((0, i.Wi)(y)) {
                                if (!(T = y.options[m] || y.options.other)) throw new o.C8(y.value, m, Object.keys(y.options), f);
                                h.push.apply(h, a(T.value, e, n, u, c))
                            } else if ((0, i.Jo)(y)) {
                                var T;
                                if (!(T = y.options["=".concat(m)])) {
                                    ...
                                    T = y.options[A] || y.options.other
                                }
                                if (!T) throw new o.C8(y.value, m, Object.keys(y.options), f);
                                h.push.apply(h, a(T.value, e, n, u, c, m - (y.offset || 0)))
                            } else;
                        }
                    }
                }
        ...
        635872: (t, e, n) => {
            ...
            function h(t, e) {
                ...
                var i = !e || e.state !== c && e.state !== u ? void 0 : e.value;
            ...
            function p(t, e, n) {
                ...
                return {
                    current: function() {
                        return o(!a, "subscribingObservable has already been disposed"), l.reportObserved() || s || console.warn("Called `get` of a subscribingObservable outside a reaction. Current value will be returned but no new subscription has started"), u
                    },
                    dispose: function() {
                        a = !0, c()
                    },
            ...
            function y(t, e) {
                var n;
                void 0 === e && (e = !1);
                var i = (0, r.computed)(t);
                return (n = {
                    subscribe: function(t) {
                        return "function" == typeof t ? {
                            unsubscribe: (0, r.observe)(i, (function(e) {
                                var n = e.newValue;
                                return t(n)
                            }), e)
            ...
            ! function() {
                function t(t) {
                    ...
                    }), (0, r.makeObservable)(this), o((0, r.isObservableObject)(t), "createViewModel expects an observable object");
                    var n = a(this);
                    a(t).forEach((function(i) {
                        var s;
                        if (!n.includes(i) && i !== r.$mobx && "__mobxDidRunLazyInitializers" !== i) {
                            if (o(-1 === b.indexOf(i), "The propertyname " + i + " is reserved and cannot be used with viewModels"), (0, r.isComputedProp)(t, i)) {
                                var a = (0, r._getAdministration)(t, i),
                                    u = a.derivation.bind(e),
                                    c = null === (s = a.setter_) || void 0 === s ? void 0 : s.bind(e);
                                e.localComputedValues.set(i, (0, r.computed)(u, {
                                    set: c
                                }))
                            }
                            ...
                            Object.defineProperty(e, i, v(v({}, f), {
                                configurable: !0,
                                get: function() {
                                    return (0, r.isComputedProp)(t, i) ? e.localComputedValues.get(i).get() : e.isPropertyDirty(i) ? e.localValues.get(i) : e.model[i]
                                },
                                set: (0, r.action)((function(n) {
                                    (0, r.isComputedProp)(t, i) ? e.localComputedValues.get(i).set(n): n !== e.model[i] ? e.localValues.set(i, n) : e.localValues.delete(i)
                                }))
                            }))
                        }
                    }))
                    ...
                    value: function() {
                        ...
                        (0, r.keys)(this.localValues).forEach((function(e) {
                            var n = t.localValues.get(e),
                                i = t.model[e];
                            (0, r.isObservableArray)(i) ? i.replace(n): (0, r.isObservableMap)(i) ? (i.clear(), i.merge(n)) : (0, r.isComputed)(n) || (t.model[e] = n)
            ...
            function A(t, e) {
                ...
                var n = new Map,
                    ...
                    s = !1,
                    a = void 0;
                "object" == typeof e ? (i = e.onCleanup, s = void 0 !== e.keepAlive && e.keepAlive, a = e.debugNameGenerator) : "function" == typeof e && (i = e);
                var u = !1;
                return function(o) {
                    ! function(t) {
                        var e = typeof t;
                    ...
                    return c = function(o) {
                        var u, c = {};
                        "object" == typeof e ? (i = e.onCleanup, a = e.debugNameGenerator, c = e) : "function" == typeof e ? i = e : (i = void 0, a = void 0);
                        var l = typeof o,
                            f = a ? a(o) : "Transformer-" + t.name + "-" + ("string" === l || "number" === l ? o : "object"),
                        ...
                        if (!s) var p = (0, r.onBecomeUnobserved)(h, (function() {
                            n.delete(o), p(), i && i(u, o)
                        }));
                        return h
                    }(o), n.set(o, c), c.get()
                }
            }
            var O, x = (O = function(t, e) {
                    return O = Object.setPrototypeOf || {
                        __proto__: []
                    }
                    instanceof Array && function(t, e) {
            ...
            function C(t, e) {
                ...
                return function() {
                    ...
                    if (!o.keepAlive && !(0, r._isComputingDerivation)()) return !n && (0, r._getGlobalState)().computedRequiresReaction && (console.warn("Invoking a computedFn from outside a reactive context won't be memoized unless keepAlive is set."), n = !0), t.apply(this, a);
                    var f = (0, r.computed)((function() {
                        return c = t.apply(e, a)
                    }), S(S({}, o), {
                        name: "computedFn(" + (o.name || t.name) + "#" + ++i + ")"
                    }));
                    return l.set(f), o.keepAlive || (0, r.onBecomeUnobserved)(f, (function() {
                        s.entry(a).delete(), o.onCleanup && o.onCleanup.apply(o, P([c], a)), c = void 0
                    })), f.get()
                }
            }
        },
        621652: t => {
            ! function() {
                function e(t, e) {
                    var n, r, i, o, s, a, u, c;
                    for (n = 3 & t.length, r = t.length - n, i = e, s = 3432918353, a = 461845907, c = 0; c < r;) u = 255 & t.charCodeAt(c) | (255 & t.charCodeAt(++c)) << 8 | (255 & t.charCodeAt(++c)) << 16 | (255 & t.charCodeAt(++c)) << 24, ++c, i = 27492 + (65535 & (o = 5 * (65535 & (i = (i ^= u = (65535 & (u = (u = (65535 & u) * s + (((u >>> 16) * s & 65535) << 16) & 4294967295) << 15 | u >>> 17)) * a + (((u >>> 16) * a & 65535) << 16) & 4294967295) << 13 | i >>> 19)) + ((5 * (i >>> 16) & 65535) << 16) & 4294967295)) + ((58964 + (o >>> 16) & 65535) << 16);
                    switch (u = 0, n) {
                        case 3:
                        ...
                        case 1:
                            i ^= u = (65535 & (u = (u = (65535 & (u ^= 255 & t.charCodeAt(c))) * s + (((u >>> 16) * s & 65535) << 16) & 4294967295) << 15 | u >>> 17)) * a + (((u >>> 16) * a & 65535) << 16) & 4294967295
                    }
                ...
                var n = e;
                n.v2 = function(t, e) {
                    for (var n, r = t.length, i = e ^ r, o = 0; r >= 4;) n = 1540483477 * (65535 & (n = 255 & t.charCodeAt(o) | (255 & t.charCodeAt(++o)) << 8 | (255 & t.charCodeAt(++o)) << 16 | (255 & t.charCodeAt(++o)) << 24)) + ((1540483477 * (n >>> 16) & 65535) << 16), i = 1540483477 * (65535 & i) + ((1540483477 * (i >>> 16) & 65535) << 16) ^ (n = 1540483477 * (65535 & (n ^= n >>> 24)) + ((1540483477 * (n >>> 16) & 65535) << 16)), r -= 4, ++o;
                    switch (r) {
                        case 3:
        ...
        361443: (t, e, n) => {
            ...
            const A = void 0 !== o.ResizeObserver ? o.ResizeObserver : T
        },
        473124: (t, e, n) => {
            "use strict";
            ...
            var r = n(834023),
                ...
                u = function() {
                    ...
                    return t.prototype.lift = function(e) {
                        ...
                        var r = this.operator,
                            o = (0, i.Y)(t, e, n);
                        if (r ? o.add(r.call(o, this.source)) : o.add(this.source || a.v.useDeprecatedSynchronousErrorHandling && !o.syncErrorThrowable ? this._subscribe(o) : this._trySubscribe(o)), a.v.useDeprecatedSynchronousErrorHandling && o.syncErrorThrowable && (o.syncErrorThrowable = !1, o.syncErrorThrown)) throw o.syncErrorValue;
                        return o
                        ...
                        if (!this.closed) {
                            ...
                            if ((0, o.m)(l)) {
                                ...
                                try {
                                    ...
                                    e = y instanceof s.B ? u(y.errors) : [y]
                                }
                            }
                            if ((0, r.k)(f)) {
                                h = -1;
                                for (var p = f.length; ++h < p;) {
                                    ...
                                    if ((0, i.K)(d)) try {
                                        ...
                                        e = e || [], y instanceof s.B ? e = e.concat(u(y.errors)) : e.push(y)
                                    }
                                }
                            }
        ...
        962966: (t, e, n) => {
            ...
            var u = function() {
                    function t(t) {
                        if (this.total = t, this.total < 0) throw new o.W
                    }
                    return t.prototype.call = function(t, e) {
        ...
        408225: (t, e, n) => {
            ...
            var r = n(218002),
                ...
                h = function(t) {
                    ...
                    if ((0, u.t)(t)) return (0, i.A)(t);
                    if (t && "function" == typeof t[l.hZ]) return (0, o.u)(t);
        ...
        503216: (t, e, n) => {
            var r = n(470977),
                ...
                u = n(716877),
                c = n(546580);
            c.alea = r, c.xor128 = i, c.xorwow = o, c.xorshift7 = s, c.xor4096 = a, c.tychei = u, t.exports = c
        },
        470977: function(t, e, n) {
            ...
            ! function(t, i, o) {
                ...
                function u(t, e) {
                    ...
                    }, i.quick = i, r && ("object" == typeof r && a(r, n), i.state = function() {
                        return a(n, {})
                    }), i
                }
            ...
            ! function(t, i, o) {
                ...
                function u(t, e) {
                    ...
                    return i.double = function() {
                        ...
                        return t
                    }, i.int32 = n.next, i.quick = i, r && ("object" == typeof r && a(r, n), i.state = function() {
                        return a(n, {})
                    }), i
                }
                i && i.exports ? i.exports = u : n.amdD && n.amdO ? void 0 === (r = function() {
            ...
            ! function(t, i, o) {
                function s(t) {
                    ...
                    e.next = function() {
                        ...
                        function(t, e) {
                            var n, r, i, o, s, a = [],
                                u = 128;
                            for (e === (0 | e) ? (r = e, e = null) : (e += "\0", r = 0, u = Math.max(u, e.length)), i = 0, o = -32; o < u; ++o) e && (r ^= e.charCodeAt((o + 32) % e.length)), 0 === o && (s = r), r ^= r << 10, r ^= r >>> 15, r ^= r << 4, r ^= r >>> 13, o >= 0 && (s = s + 1640531527 | 0, i = 0 == (n = a[127 & o] ^= r + s) ? i + 1 : 0);
                            for (i >= 128 && (a[127 & (e && e.length || 0)] = -1), i = 127, o = 512; o > 0; --o) r = a[i + 34 & 127], n = a[i = i + 1 & 127], r ^= r << 13, n ^= n << 17, r ^= r >>> 15, n ^= n >>> 12, a[i] = r ^ n;
                            t.w = s, t.X = a, t.i = i
                        }(e, t)
                }
                ...
                function u(t, e) {
                    ...
                    return i.double = function() {
                        ...
                        return t
                    }, i.int32 = n.next, i.quick = i, r && (r.X && a(r, n), i.state = function() {
                        return a(n, {})
                    }), i
                }
                i && i.exports ? i.exports = u : n.amdD && n.amdO ? void 0 === (r = function() {
            ...
            ! function(i, o, s) {
                ...
                function p(t, e, n) {
                    var r = [],
                        h = m(v((e = 1 == e ? {
                            entropy: !0
                        } : e || {}).entropy ? [t, b(o)] : null == t ? function() {
                            try {
                                var t;
                                return a && (t = a.randomBytes) ? t = t(u) : (t = new Uint8Array(u), (i.crypto || i.msCrypto).getRandomValues(t)), b(t)
                            } catch (r) {
                                var e = i.navigator,
                                    n = e && e.plugins;
                    ...
                    }, g.double = g, m(b(p.S), o), (e.pass || n || function(t, e, n, r) {
                ...
                function d(t) {
                    var e, n = t.length,
                        ...
                        s = r.S = [];
                    for (n || (t = [n++]); i < u;) s[i] = i++;
                    for (i = 0; i < u; i++) s[i] = s[o = h & o + t[i % n] + (e = s[i])], s[o] = e;
                    (r.g = function(t) {
                        for (var e, n = 0, i = r.i, o = r.j, s = r.S; t--;) e = s[i = h & i + 1], n = n * u + s[h & (s[i] = s[o = h & o + e]) + (s[o] = e)];
        ...
        741137: (t, e, n) => {
            ...
            var r = ["input:not([inert])", "select:not([inert])", "textarea:not([inert])", "a[href]:not([inert])", "button:not([inert])", "[tabindex]:not(slot):not([inert])", "audio[controls]:not([inert])", "video[controls]:not([inert])", '[contenteditable]:not([contenteditable="false"]):not([inert])', "details>summary:first-of-type:not([inert])", "details:not([inert])"],
                ...
                s = o ? function() {} : Element.prototype.matches || Element.prototype.msMatchesSelector || Element.prototype.webkitMatchesSelector,
                ...
                u = function t(e, n) {
                    var r;
                    void 0 === n && (n = !0);
                    var i = null == e || null === (r = e.getAttribute) || void 0 === r ? void 0 : r.call(e, "inert");
                    ...
                    for (var o = [], a = Array.from(e); a.length;) {
                        ...
                        if (!u(c, !1))
                            if ("SLOT" === c.tagName) {
                                ...
                                s.call(c, i) && r.filter(c) && (n || !e.includes(c)) && o.push(c);
                ...
                m = function(t, e) {
                    ...
                    var i = s.call(t, "details>summary:first-of-type") ? t.parentElement : t;
                    ...
                    if (n && "full" !== n && "legacy-full" !== n) {
                        ...
                        if (function(t) {
                                var e, n, r, i, o = t && a(t),
                                    ...
                                    u = !1;
                                if (o && o !== t)
                                    for (u = !!(null !== (n = s) && void 0 !== n && null !== (r = n.ownerDocument) && void 0 !== r && r.contains(s) || null != t && null !== (i = t.ownerDocument) && void 0 !== i && i.contains(t)); !u && s;) {
                                        var c, l, f;
                                        u = !(null === (l = s = null === (c = o = a(s)) || void 0 === c ? void 0 : c.host) || void 0 === l || null === (f = l.ownerDocument) || void 0 === f || !f.contains(s))
                                    }
                                return u
                ...
                w = function t(e) {
                    ...
                    return e.forEach((function(e, i) {
                        var o = !!e.scopeParent,
                            ...
                            u = o ? t(e.candidates) : s;
                        0 === a ? o ? n.push.apply(n, u) : n.push(s) : r.push({
                            documentOrder: i,
                            tabIndex: a,
                            item: e,
                            isScope: o,
        ...
        552170: (t, e, n) => {
            ...
            ! function() {
                ...
                function k(t) {
                    return "display:block;position:absolute;top:-9999px;left:-9999px;font-size:300px;width:auto;height:auto;line-height:normal;margin:0;padding:0;font-variant:normal;white-space:nowrap;font-family:" + T(t.c) + ";font-style:" + O(t) + ";font-weight:" + t.f + "00;"
                }
                ...
                function j(t, e, n, r, i, o, s) {
                    this.v = t, this.B = e, this.c = n, this.a = r, this.s = s || "BESbswy", this.f = {}, this.w = i || 3e3, this.u = o || null, this.m = this.j = this.h = this.g = null, this.g = new C(this.c, this.s), this.h = new C(this.c, this.s), this.j = new C(this.c, this.s), this.m = new C(this.c, this.s), t = k(t = new _(this.a.c + ",serif", A(this.a))), this.g.a.style.cssText = t, t = k(t = new _(this.a.c + ",sans-serif", A(this.a))), this.h.a.style.cssText = t, t = k(t = new _("serif", A(this.a))), this.j.a.style.cssText = t, t = k(t = new _("sans-serif", A(this.a))), this.m.a.style.cssText = t, L(this.g), L(this.h), L(this.j), L(this.m)
                }
                ...
                G.prototype.g = function(t) {
                    ...
                    if (e.g) {
                        ...
                        n || r.push(e.a.c("wf", t.c, A(t).toString(), "inactive")), p(e.f, r, i)
                    }
                        ...
                        if (o["__mti_fntLst" + r]) {
                            ...
                            if (i)
                                for (var a = 0; a < i.length; a++) {
                                    ...
                                    null != i[a].fontStyle && null != i[a].fontWeight ? (n = i[a].fontStyle + i[a].fontWeight, s.push(new _(u, n))) : s.push(new _(u))
                                }
                            t(s)
                    ...
                    var e, n, r = this.a.urls || [],
                        ...
                        s = new m;
                    for (e = 0, n = r.length; e < n; e++) y(this.c, r[e], b(s));
                    var a = [];
                    ...
                    ! function(t) {
                        for (var e = t.f.length, n = 0; n < e; n++) {
                            ...
                            if (2 <= r.length) {
                                ...
                                0 < s.length && (o = s), 3 == r.length && (s = [], 0 < (r = (r = r[2]) ? r.split(",") : s).length && (r = J[r[0]]) && (t.c[i] = r))
                            }
                            for (t.c[i] || (r = J[i]) && (t.c[i] = r), r = 0; r < o.length; r += 1) t.a.push(new _(i, o[r]))
                        }
                    }(o), y(n, function(t) {
                    ...
                    e ? v(this.c, (this.a.api || "https://use.typekit.net") + "/" + e + ".js", (function(e) {
                        if (e) t([]);
                            ...
                            for (var r = [], i = 0; i < e.length; i += 2)
                                for (var o = e[i], s = e[i + 1], a = 0; a < s.length; a++) r.push(new _(o, s[a]));
                            try {
                                n.Typekit.load({
                                    events: !1,
                                    classes: !1,
        ...
        474183: (t, e, n) => {
            ...
            async function s(t, e) {
                ...
                const {
                    ...
                    altBoundary: p = !1,
                    padding: d = 0
                } = (0, r.ku)(e, t), y = (0, r.yd)(d), v = u[p ? "floating" === h ? "reference" : "floating" : h], m = (0, r.JB)(await s.getClippingRect({
                ...
                return {
                    top: (m.top - w.top + y.top) / E.y,
                    bottom: (w.bottom - m.bottom + y.bottom) / E.y,
                    left: (m.left - w.left + y.left) / E.x,
                    right: (w.right - m.right + y.right) / E.x
                }
            }
            const a = t => ({
                name: "arrow",
                ...
                async fn(e) {
                    ...
                    let A = T ? T[E] : 0;
                    A && await (null == a.isElement ? void 0 : a.isElement(T)) || (A = u.floating[E] || s.floating[y]);
                    const O = w / 2 - _ / 2,
                        x = A / 2 - v[y] / 2 - 1,
                        R = (0, r.VV)(h[b], x),
                        N = (0, r.VV)(h[g], x),
                        ...
                        C = A / 2 - v[y] / 2 + O,
                        L = (0, r.uZ)(S, C, P),
                        k = !c.arrow && null != (0, r.hp)(o) && C !== L && s.reference[y] / 2 - (C < S ? R : N) - v[y] / 2 < 0,
                        I = k ? C < S ? C - S : C - P : 0;
                    return {
                        [d]: p[d] + I,
                        data: {
            ...
            const u = function(t) {
                    return void 0 === t && (t = {}), {
                        ...
                        async fn(e) {
                            ...
                            }(p || null, y, d) : d, b = await s(e, v), g = (null == (n = u.autoPlacement) ? void 0 : n.index) || 0, E = m[g];
                            if (null == E) return {};
                            ...
                            const _ = [b[(0, r.k3)(E)], b[w[0]], b[w[1]]],
                                T = [...(null == (i = u.autoPlacement) ? void 0 : i.overflows) || [], {
                                    placement: E,
                                    overflows: _
                                }],
                                A = m[g + 1];
                            ...
                            const O = T.map((t => {
                                ...
                                x = (null == (o = O.filter((t => t[2].slice(0, (0, r.hp)(t[0]) ? 2 : 3).every((t => t <= 0))))[0]) ? void 0 : o[0]) || O[0][0];
                            return x !== c ? {
                                data: {
                                    index: g + 1,
                                    overflows: T
                ...
                c = function(t) {
                    return void 0 === t && (t = {}), {
                        ...
                        async fn(e) {
                            ...
                            d || "none" === v || _.push(...(0, r.KX)(c, m, v, w));
                            const T = [c, ..._],
                                A = await s(e, b),
                                O = [];
                            let x = (null == (i = a.flip) ? void 0 : i.overflows) || [];
                            if (h && O.push(A[g]), p) {
                                const t = (0, r.i8)(o, u, w);
                                O.push(A[t[0]], A[t[1]])
                            }
                            if (x = [...x, {
                                    placement: o,
                                ...
                                let n = null == (N = x.filter((t => t.overflows[0] <= 0)).sort(((t, e) => t.overflows[1] - e.overflows[1]))[0]) ? void 0 : N.placement;
                                if (!n) switch (y) {
                                    case "bestFit":
                                        {
                                            var S;
                ...
                return void 0 === t && (t = {}), {
                    ...
                    async fn(e) {
                        const {
                            ...
                            x: c,
                            y: l
                        } = (0, r.ku)(t, e), f = Array.from(await (null == s.getClientRects ? void 0 : s.getClientRects(i.reference)) || []), h = function(t) {
                            const e = t.slice().sort(((t, e) => t.y - e.y)),
                                n = [];
                            let i = null;
                            for (let r = 0; r < e.length; r++) {
                                const t = e[r];
                                !i || t.y - i.y > i.height / 2 ? n.push([t]) : n[n.length - 1].push(t), i = t
                            }
                                ...
                                getBoundingClientRect: function() {
                                    ...
                                    if (h.length >= 2) {
                                        ...
                                        const t = "left" === (0, r.k3)(n),
                                            ...
                                            i = (0, r.VV)(...h.map((t => t.left))),
                                            o = h.filter((n => t ? n.left === i : n.right === e)),
                                            s = o[0].top,
                        ...
                        async fn(e) {
                            ...
                            const {
                                ...
                                const {
                                    ...
                                    platform: i,
                                    elements: o
                                } = t, s = await (null == i.isRTL ? void 0 : i.isRTL(o.floating)), a = (0, r.k3)(n), u = (0, r.hp)(n), c = "y" === (0, r.Qq)(n), l = ["left", "top"].includes(a) ? -1 : 1, f = s && c ? -1 : 1, h = (0, r.ku)(e, t);
                                let {
                                    mainAxis: p,
                                    crossAxis: d,
                                    alignmentAxis: y
                            ...
                            return a === (null == (n = u.offset) ? void 0 : n.placement) && null != (i = u.arrow) && i.alignmentOffset ? {} : {
                                x: o + c.x,
                                y: s + c.y,
                                data: { ...c,
                                    placement: a
                    ...
                    return void 0 === t && (t = {}), {
                        ...
                        async fn(e) {
                            const {
                                ...
                                x: n,
                                y: i
                            }, h = await s(e, l), p = (0, r.Qq)((0, r.k3)(o)), d = (0, r.Rn)(p);
                            let y = f[d],
                                v = f[p];
                            if (a) {
                        ...
                        fn(e) {
                            ...
                            if (l) {
                                ...
                                const t = "y" === p ? "width" : "height",
                                    ...
                                    i = s.reference[h] + s.reference[t] + (e ? 0 : (null == (g = a.offset) ? void 0 : g[h]) || 0) - (e ? m.crossAxis : 0);
                                y < n ? y = n : y > i && (y = i)
                            }
                            return {
                                [p]: d,
                ...
                b = function(t) {
                    return void 0 === t && (t = {}), {
                        ...
                        async fn(e) {
                            ...
                            let v, m;
                            "top" === f || "bottom" === f ? (v = f, m = h === (await (null == o.isRTL ? void 0 : o.isRTL(a.floating)) ? "start" : "end") ? "left" : "right") : (m = f, v = "end" === h ? "top" : "bottom");
                            const b = y - l.top - l.bottom,
                                g = d - l.left - l.right,
                                E = (0, r.VV)(y - l[v], b),
                                w = (0, r.VV)(d - l[m], g),
                            ...
                            if (p ? A = h || _ ? (0, r.VV)(w, g) : g : T = h || _ ? (0, r.VV)(E, b) : b, _ && !h) {
                                const t = (0, r.Fp)(l.left, 0),
                                    ...
                                    n = (0, r.Fp)(l.top, 0),
                                    i = (0, r.Fp)(l.bottom, 0);
                                p ? A = d - 2 * (0 !== t || 0 !== e ? t + e : (0, r.Fp)(l.left, l.right)) : T = y - 2 * (0 !== n || 0 !== i ? n + i : (0, r.Fp)(l.top, l.bottom))
                            }
                            await u({ ...e,
                                availableWidth: A,
                                availableHeight: T
        ...
        84186: (t, e, n) => {
            ...
            function s(t) {
                ...
                const s = (0, o.Re)(t),
                    a = s ? t.offsetWidth : n,
                    u = s ? t.offsetHeight : i,
                    c = (0, r.NM)(n) !== a || (0, r.NM)(i) !== u;
                return c && (n = a, i = u), {
                    width: n,
                    height: i,
                    $: c
            ...
            function u(t) {
                ...
                let l = (c ? (0, r.NM)(n.width) : n.width) / i,
            ...
            function f(t, e, n, i) {
                ...
                if (c) {
                    ...
                    for (; r && i && e !== n;) {
                        ...
                        p *= t.x, d *= t.y, y *= t.x, v *= t.y, p += s, d += a, n = (0, o.Jj)(r), r = n.frameElement
                    }
                }
                return (0, r.JB)({
                    width: y,
            ...
            function d(t) {
                return f((0, o.tF)(t)).left + (0, o.Lw)(t).scrollLeft
            }
            ...
            function y(t, e, n) {
                ...
                if ("viewport" === e) i = function(t, e) {
                    ...
                    if (i) {
                        ...
                        const t = (0, o.Pf)();
                        (!t || t && "fixed" === e) && (u = i.offsetLeft, c = i.offsetTop)
                    }
                    return {
                        width: s,
                        height: a,
                    ...
                    const e = (0, o.tF)(t),
                        ...
                        s = (0, r.Fp)(e.scrollWidth, e.clientWidth, i.scrollWidth, i.clientWidth),
                        a = (0, r.Fp)(e.scrollHeight, e.clientHeight, i.scrollHeight, i.clientHeight);
                    let u = -n.scrollLeft + d(t);
                    const c = -n.scrollTop;
                    return "rtl" === (0, o.Dx)(i).direction && (u += (0, r.Fp)(e.clientWidth, i.clientWidth) - s), {
                        width: s,
                        height: a,
                        x: u,
                        y: c
                ...
                else if ((0, o.kK)(e)) i = function(t, e) {
                    const n = f(t, !0, "fixed" === e),
                        i = n.top + t.clientTop,
                        s = n.left + t.clientLeft,
                        a = (0, o.Re)(t) ? u(t) : (0, r.ze)(1);
                    return {
            ...
            function v(t, e) {
                const n = (0, o.Ow)(t);
                return !(n === e || !(0, o.kK)(n) || (0, o.Py)(n)) && ("fixed" === (0, o.Dx)(n).position || v(n, e))
            }
            ...
            function m(t, e, n) {
                ...
                const l = (0, r.ze)(0);
                if (i || !i && !a)
                    if (("body" !== (0, o.wk)(e) || (0, o.ao)(s)) && (c = (0, o.Lw)(e)), i) {
                        const t = f(e, !0, a, e);
            ...
            function g(t, e) {
                return (0, o.Re)(t) && "fixed" !== (0, o.Dx)(t).position ? e ? e(t) : t.offsetParent : null
            }
            ...
            function E(t, e) {
                ...
                if (!(0, o.Re)(t)) {
                    let e = (0, o.Ow)(t);
                    for (; e && !(0, o.Py)(e);) {
                        if ((0, o.kK)(e) && !b(e)) return e;
                        e = (0, o.Ow)(e)
                    }
                    return n
                }
                let r = g(t, e);
                for (; r && (0, o.Ze)(r) && b(r);) r = g(r, e);
                return r && (0, o.Py)(r) && b(r) && !(0, o.hT)(r) ? n : r || (0, o.gQ)(t) || n
            }
            const w = {
                convertOffsetParentRelativeRectToViewportRelativeRect: function(t) {
                    ...
                    const y = (0, r.ze)(0),
                        v = (0, o.Re)(i);
                    if ((v || !v && !a) && (("body" !== (0, o.wk)(i) || (0, o.ao)(c)) && (h = (0, o.Lw)(i)), (0, o.Re)(i))) {
                        const t = f(i);
                        d = u(i), y.x = t.x + i.clientLeft, y.y = t.y + i.clientTop
                    }
                    return {
                        width: n.width * d.x,
                        height: n.height * d.y,
                ...
                getClippingRect: function(t) {
                    ...
                    const a = [..."clippingAncestors" === n ? p(e) ? [] : function(t, e) {
                            const n = e.get(t);
                            if (n) return n;
                            let r = (0, o.Kx)(t, [], !1).filter((t => (0, o.kK)(t) && "body" !== (0, o.wk)(t))),
                                i = null;
                            const s = "fixed" === (0, o.Dx)(t).position;
                            let a = s ? (0, o.Ow)(t) : t;
                            for (;
                                (0, o.kK)(a) && !(0, o.Py)(a);) {
                                const e = (0, o.Dx)(a),
                                    n = (0, o.hT)(a);
                                n || "fixed" !== e.position || (i = null), (s ? !n && !i : !n && "static" === e.position && i && ["absolute", "fixed"].includes(i.position) || (0, o.ao)(a) && !n && v(t, a)) ? r = r.filter((t => t !== a)) : i = e, a = (0, o.Ow)(a)
                            }
                            return e.set(t, r), r
            ...
            function _(t, e, n, i) {
                ...
                const {
                    ...
                    animationFrame: h = !1
                } = i, p = a(t), d = s || u ? [...p ? (0, o.Kx)(p) : [], ...(0, o.Kx)(e)] : [];
                d.forEach((t => {
                ...
                const y = p && l ? function(t, e) {
                    ...
                    return function o(u, c) {
                        ...
                        try {
                            i = new IntersectionObserver(v, { ...d,
                ...
                return h && function e() {
                    ...
                    })), null == y || y(), null == (t = b) || t.disconnect(), b = null, h && cancelAnimationFrame(v)
                }
            }
            const T = i.US,
                A = i.cv,
        ...
        694788: (t, e, n) => {
            ...
            function f(t) {
                ...
                a(E, f) || w(f);
                const [_, T] = i.useState(null), [A, O] = i.useState(null), x = i.useCallback((t => {
                    t !== P.current && (P.current = t, T(t))
                }), []), R = i.useCallback((t => {
                    t !== C.current && (C.current = t, O(t))
                }), []), N = p || _, S = d || A, P = i.useRef(null), C = i.useRef(null), L = i.useRef(b), k = null != v, I = l(v), j = l(h), B = i.useCallback((() => {
                    ...
                    j.current && (t.platform = j.current), (0, r.oo)(P.current, C.current, t).then((t => {
                        ...
                        M.current && !a(L.current, e) && (L.current = e, o.flushSync((() => {
                            g(e)
                        })))
                    }))
                }), [E, e, n, j]);
            ...
            const h = t => ({
                    ...
                    fn(e) {
                        ...
                        return n && (o = n, {}.hasOwnProperty.call(o, "current")) ? null != n.current ? (0, r.x7)({
                            element: n.current,
                            padding: i
                        }).fn(e) : {} : n ? (0, r.x7)({
                            element: n,
        ...
        725352: (t, e, n) => {
            ...
            var i = n(875604),
                o = (n(187128), n(573662), n(84186), n(291477)),
                s = n(694788);
            n(741137), n(204358);
            const a = { ...r || (r = n.t(i, 2))
                },
            ...
            const l = "ArrowUp",
                ...
                h = "ArrowLeft",
                p = "ArrowRight";
            var d = "undefined" != typeof document ? i.useLayoutEffect : i.useEffect;
            const y = [h, p],
                v = [l, f];
            let m = !1,
                b = 0;
            ...
            const E = a.useId || function() {
                const [t, e] = i.useState((() => m ? g() : void 0));
                return d((() => {
                    null == t && e(g())
                }), []), i.useEffect((() => {
                    m = !0
            ...
            const _ = i.createContext(null),
                ...
                A = () => {
                    var t;
                    return (null == (t = i.useContext(_)) ? void 0 : t.id) || null
                },
                O = () => i.useContext(T);
            ...
            function x(t) {
                ...
                const {
                    ...
                    const {
                        ...
                        onOpenChange: n,
                        elements: r
                    } = t, o = E(), s = i.useRef({}), [a] = i.useState((() => w())), u = null != A(), [l, f] = i.useState(r.reference), h = c(((t, e, r) => {
                ...
                }), r = t.rootContext || n, a = r.elements, [u, l] = i.useState(null), [f, h] = i.useState(null), p = (null == a ? void 0 : a.reference) || u, y = i.useRef(null), v = O();
                d((() => {
                    p && (y.current = p)
                }), [p]);
                const m = (0, s.YF)({ ...t,
                    ...
                    g = i.useCallback((t => {
                        ((0, o.kK)(t) || null === t) && (y.current = t, l(t)), ((0, o.kK)(m.refs.reference.current) || null === m.refs.reference.current || null !== t && !(0, o.kK)(t)) && m.refs.setReference(t)
                    }), [m.refs]),
                    _ = i.useMemo((() => ({ ...m.refs,
                        setReference: g,
        ...
        291477: (t, e, n) => {
            ...
            function b(t) {
                ...
                const e = t.assignedSlot || t.parentNode || c(t) && t.host || o(t);
                return c(e) ? e.host : e
            }
            ...
            function E(t, e, n) {
                ...
                const o = g(t),
                    ...
                    a = i(o);
                return s ? e.concat(a, a.visualViewport || [], l(o) ? o : [], a.frameElement && n ? E(a.frameElement) : []) : e.concat(o, E(o, [], n))
            }
            n.d(e, {
                Dx: () => v,
                Jj: () => i,
        ...
        573662: (t, e, n) => {
            ...
            function w(t, e, n) {
                ...
                return e.reference[o] > e.floating[o] && (s = O(s)), [s, O(s)]
            }
            ...
            function A(t, e, n, r) {
                ...
                return i && (o = o.map((t => t + "-" + i)), e && (o = o.concat(o.map(T)))), o
            }
            ...
            var c = function(t) {
                ...
                for (var e = {}, n = 0; n < t.length; ++n) {
                    ...
                    if (o && "object" === r(o) && (o = String(o)), "string" != typeof o) {
                        var s = "Locales should be strings, ".concat(JSON.stringify(o), " isn't.");
                    ...
                    v = function() {
                        function v() {
                            ...
                            ! function(t, e) {
                                ...
                                var o = (new t).resolvedOptions().locale;
                                return a(o)
                            }(n)), s(this, p, e(o(this, f))), s(this, h, r(o(this, f))), s(this, d, function(t) {
                        ...
                        return m = v, g = [{
                            ...
                            key: "resolvedOptions",
                            value: function() {
                                var t = o(this, y).resolvedOptions(),
                                ...
                                return "number" == typeof s && (c.minimumSignificantDigits = s, c.maximumSignificantDigits = a), c.pluralCategories = n(o(this, f), "ordinal" === o(this, d)).slice(0), c.roundingPriority = u || "auto", c
                            }
                        }, {
                            key: "select",
                            value: function(t) {
                                ...
                                var e = o(this, y).format(Math.abs(t));
                                return o(this, p).call(this, e, "ordinal" === o(this, d))
                            }
                        }, {
                            key: "selectRange",
                            value: function(t, e) {
                                ...
                                return o(this, h).call(this, this.select(n), this.select(r))
                            }
                        }]) && i(m.prototype, b), g && i(m, g), Object.defineProperty(m, "prototype", {
                            writable: !1
                        }), v
                    }();
